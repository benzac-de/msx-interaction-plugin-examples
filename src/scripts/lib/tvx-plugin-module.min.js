...
var M=decodeURIComponent(K.substr(J+1));if(P(O,M)===true){break}}}}};this.remove=function(J){if(a.isFullStr(J)){this.set(J,"",I)}};this.clear=function(){var J=this;this.foreach(function(K){J.set(K,"",I)})}}function d(){var K="exp:";var J=new H();var I=function(M,N){if(N!=null){N*=1;return N>=0&&N<M}return false};var L=function(){if(window.localStorage!=null){var O=[];var P=g.getTimestamp();for(var N=0;N<localStorage.length;N++){var M=localStorage.key(N);if(M!=null&&M.indexOf(K)==0){if(I(P,localStorage.getItem(M))){O.push(M.substr(K.length))}}}for(var N=0;N<O.length;N++){localStorage.removeItem(O[N]);localStorage.removeItem(K+O[N])}}};this.set=function(M,P,O){if(a.isFullStr(M)&&P!=null){if(window.localStorage!=null){var N=-1;if(O!=null){if(typeof O=="number"){N=new Date().getTime()+O}else{if(typeof O=="string"){N=new Date(O).getTime()}else{if(typeof O.getTime=="function"){N=O.getTime()}}}}localStorage.setItem(M,P);if(N>=0){localStorage.setItem(K+M,N)}else{localStorage.removeItem(K+M)}}else{J.set(M,P,O)
}}};this.get=function(M,P){if(a.isFullStr(M)){if(window.localStorage!=null){var O=false;var N=localStorage.getItem(K+M);if(N!=null){if(I(g.getTimestamp(),N)){O=true;localStorage.removeItem(M);localStorage.removeItem(K+M)}}if(!O){var Q=localStorage.getItem(M);if(Q!=null){return Q}}}else{return J.get(M,P)}}return P!=null?P:null};this.getFullStr=function(M,N){return a.strFullCheck(this.get(M),N)};this.getNum=function(M,N){return a.strToNum(this.get(M),N)};this.getBool=function(M,N){return a.strToBool(this.get(M),N)};this.has=function(M,N){return a.isValid(this.get(M),N)};this.foreach=function(O){if(typeof O=="function"){if(window.localStorage!=null){L();for(var N=0;N<localStorage.length;N++){var M=localStorage.key(N);if(M!=null&&M.indexOf(K)!=0){if(O(M,localStorage.getItem(M))===true){break}}}}else{J.foreach(O)}}};this.remove=function(M){if(a.isFullStr(M)){if(window.localStorage!=null){localStorage.removeItem(M);localStorage.removeItem(K+M)}else{J.remove(M)}}};this.clear=function(){if(window.localStorage!=null){localStorage.clear()
}else{J.clear()}}}function A(J){var I=null;this.set=function(K,L){if(a.isFullStr(K)&&L!=null){if(I==null){I={}}I[K]=L}};this.get=function(K,L){if(I!=null&&a.isFullStr(K)&&I[K]!=null){return I[K]}return L!=null?L:null};this.getFullStr=function(K,L){return a.strFullCheck(this.get(K),L)};this.getNum=function(K,L){return a.strToNum(this.get(K),L)};this.getBool=function(K,L){return a.strToBool(this.get(K),L)};this.has=function(K,L){return a.isValid(this.get(K),L)};this.foreach=function(L){if(typeof L=="function"){if(I!=null){for(var K in I){if(L(K,I[K])===true){break}}}}};this.remove=function(K){if(I!=null&&a.isFullStr(K)){delete I[K]}};this.clear=function(){I={}};this.create=function(O){var N={};if(a.isFullStr(O)){var R=O.indexOf("?");if(R>=0){var M=O.substr(R+1).split("&");for(var K=0;K<M.length;K++){var P=M[K];if(a.isFullStr(P)){var L=P.indexOf("=");if(L>0){var Q=P.substr(0,L);var S=P.substr(L+1);N[decodeURIComponent(Q)]=decodeURIComponent(S)}else{N[decodeURIComponent(P)]=""}}}}}return N};
this.build=function(N,M){var O=0;var K="";if(I!=null){for(var L in I){var P=a.strValue(I[L]);if(O>0){K+=(M!=null?M:"&")}if(a.isFullStr(P)){K+=(N===false?L:encodeURIComponent(L))+"="+(N===false?P:encodeURIComponent(P))}else{K+=(N===false?L:encodeURIComponent(L))}O++}}return K};if(J!=null){I=this.create(J)}else{I=this.create(document.URL)}}function e(I,J){this.getValue=function(K){if(a.isFullStr(K)){if(I!=null&&I[K]!=null){return I[K]}if(J!=null&&J[K]!=null){return J[K]}}return null};this.get=function(K){return a.strValue(this.getValue(K))};this.getFullStr=function(K){return a.strFullCheck(this.get(K),null)};this.getNum=function(K){return a.strToNum(this.getValue(K),0)};this.getBool=function(K){return a.strToBool(this.getValue(K),false)};this.has=function(K,L){return a.isValid(this.get(K),L)}}function h(){var I={};this.hasObserver=function(J){return a.isFullStr(J)&&I[J]!=null};this.hasObservers=function(){var J;for(J in I){return true}return false};this.addObserver=function(J,K){if(a.isFullStr(J)&&typeof K=="function"){I[J]=K
}};this.removeObserver=function(J){if(a.isFullStr(J)){delete I[J]}};this.onEvent=function(J,K){if(a.isFullStr(J)){if(typeof K=="function"){this.addObserver(J,K)}else{this.removeObserver(J)}}};this.notifyObserver=function(J,K){if(a.isFullStr(J)&&I[J]!=null){I[J](K)}};this.notifyObservers=function(K){for(var J in I){I[J](K)}};this.clear=function(){I={}}}function G(){var I={};this.hasObserver=function(K,J){return a.isFullStr(K)&&a.isFullStr(J)&&I[K]!=null&&I[K][J]!=null};this.hasObservers=function(K){if(a.isFullStr(K)&&I[K]!=null){var J;for(J in I[K]){return true}}return false};this.addObserver=function(K,J,L){if(a.isFullStr(K)&&a.isFullStr(J)&&typeof L=="function"){if(I[K]==null){I[K]={}}I[K][J]=L}};this.removeObserver=function(K,J){if(a.isFullStr(K)&&a.isFullStr(J)&&I[K]!=null){delete I[K][J];if(!this.hasObservers(K)){delete I[K]}}};this.onEvent=function(K,J,L){if(a.isFullStr(K)&&a.isFullStr(J)){if(typeof L=="function"){this.addObserver(K,J,L)}else{this.removeObserver(K,J)}}};this.notifyObserver=function(K,J,L){if(a.isFullStr(K)&&a.isFullStr(J)&&I[K]!=null&&I[K][J]!=null){I[K][J](L)
}};this.notifyObservers=function(K,L){if(a.isFullStr(K)&&I[K]!=null){for(var J in I[K]){I[K][J](L)}}};this.clear=function(J){if(a.isFullStr(J)){if(I[J]!=null){I[J]={}}}else{I={}}}}function w(){var J=null;var K=[];var I=null;var L=false;this.delegate=null;this.execute=function(){if(J!=null){clearTimeout(J);J=null}if(I!=null){if(typeof I.action=="function"){I.action()}else{if(this.delegate!=null&&typeof this.delegate.executeQueueAction=="function"){this.delegate.executeQueueAction(I.action)}}I=null;this.process()}};this.process=function(){if(I==null&&K.length>0){I=K.shift();if(I.action==="stop"&&I.delay==null){L=true;I=null}else{if(I.delay!=null&&I.delay>0){var M=this;J=setTimeout(function(){J=null;M.execute()},I.delay)}else{this.execute()}}}};this.reset=function(){K=[];I=null;L=false;if(J!=null){clearTimeout(J);J=null}};this.push=function(M,N){if(M!=null){if(M==="reset"&&N==null){this.reset()}else{if(M==="execute"&&N==null){this.execute()}else{if(M==="clear"&&N==null){K=[]}else{if(M==="continue"&&N==null){L=false
}else{K.push({action:M,delay:N})}}}}if(!L){this.process()}}};this.isBusy=function(){return J!=null}}function c(I,M){var K=null;var L=[];var J=0;this.size=I!=null?I:0;this.delay=M!=null?M:0;this.work=function(){if(K==null&&this.delay>0){var N=this;K=setTimeout(function(){K=null;J=0;N.process()},this.delay)}};this.process=function(){if(K==null&&L.length>0){if(J<this.size||this.size<=0||this.delay<=0){J++;var N=L.shift();N();this.process()}else{this.work()}}};this.reset=function(){L=[];J=0;if(K!=null){clearTimeout(K);K=null}};this.execute=function(N){if(typeof N=="function"){L.push(N);this.process()}};this.isBusy=function(){return K!=null}}function n(L){var K=null;var J=null;var I=false;this.delay=L!=null?L:0;this.start=function(M){var N=this;I=false;this.stop();J=M;if(this.delay>0){K=setTimeout(function(){N.finish()},this.delay)}else{N.finish()}};this.restart=function(){this.start(J)};this.stop=function(){if(K!=null){clearTimeout(K);K=null}};this.finish=function(){this.stop();if(!I){I=true;
if(typeof J=="function"){J()}}};this.isBusy=function(){return K!=null}}function C(){var K=300;var L=0;var I=0;var J=null;this.click=function(M){var N=g.getTimestamp();if(J===M&&L>0&&N-L<=K){I++}else{I=1}J=M;L=N;return I}}function j(){var I="application/json";var N="application/xml";var K="text/plain";var Q="text/html";var P="application/x-www-form-urlencoded";var L=function(T){var S=null;try{S=new XMLHttpRequest()}catch(R){if(T!=null&&typeof T.error=="function"){T.error("Create XML HTTP request failed: "+R)}}return S};var O=function(R){if(R!=null&&typeof R.destroy=="function"){R.destroy()}};var M=function(V,W,T){var R=V.responseText;var U=true;if(R!=null){if(T==I){try{if(window.JSON!=null&&typeof JSON.parse=="function"){if(a.isFullStr(R)){R=JSON.parse(R)}else{U=false;if(W!=null&&typeof W.error=="function"){W.error("Validate JSON failed")}}}else{if(a.isJson(R)){R=new Function("return "+R)()}else{U=false;if(W!=null&&typeof W.error=="function"){W.error("Validate JSON failed")}}}}catch(S){U=false;
if(W!=null&&typeof W.error=="function"){W.error("Create JSON failed: "+S)}}}else{if(T==N){R=V.responseXML}}}if(U&&W!=null&&typeof W.success=="function"){W.success(R)}};var J=function(X,U,W,ae,R){if(window.TVXAjaxService!=null&&typeof TVXAjaxService.executeRequest=="function"&&TVXAjaxService.executeRequest(X,U,W,ae,R)===true){return}var aa=L(ae);if(aa!=null){var ab=I;var V=false;var ac=false;var S=true;var ad=null;if(R!=null){V=R.isForm===true;ac=R.withCredentials===true;S=R.accurateHeaders!==false;ad=R.headers;if(R.dataType!=null){if(R.dataType=="json"){ab=I}else{if(R.dataType=="xml"){ab=N}else{if(R.dataType=="text"){ab=K}else{if(R.dataType=="html"){ab=Q}else{ab=null}}}}}}try{if(ac){aa.withCredentials=true}aa.open(X,U,true)}catch(Z){O(aa);aa=null;if(ae!=null&&typeof ae.error=="function"){ae.error("Open connection failed: "+Z)}}if(aa!=null){aa.onreadystatechange=function(){if(aa!=null){if(aa.readyState==4){if((aa.status>=200&&aa.status<300)||(aa.status==0&&a.isFullStr(aa.responseText))){M(aa,ae,ab)
...
if(a.isFullStr(at)&&ab(aw)&&ab(am)){var ax=I(at,aw,am);var av=at.length;var ar=am.length;var an=0;var aq=0;var ap=false;for(var al=0;al<av;al++){ao=N(ao,O(aw,am,aj(at,al),ax,an+aq,au,ap));an=Z(an,aq,ar);if(an==0){aq=M(aq,ar)}ap=!ap}}return ao};var af=function(){return L(a.strShuffle(S),S,S)};var X=function(al,am){return ai(al,ai(am,S,S),S)};var Y=function(){if(R==null){R=ae(S)}return R};this.createSteam=function(){U=af();return U};this.resolveToken=function(al){return X(al,U)};this.transformString=function(al){return V(al,Y(),S,1)};this.normalizeString=function(al){return V(al,Y(),S,-1)}}var m=new function(){var N=new o("k%hy.nLI1&4rN[D9YAPVCu(*&5F)'aC$=frs,wocT48qpRpXt[Gx$BQZU@B,9N;oL%j*J~hXbW)-#q#z7+0uMgHm3fEHcdK@iIG!?nP!/Y.3vFb~2eUz(sk-O/W?AtJ_VT_8]=+K;DmS6Q1iSx60]jaevER'l7y5ZlOdM2wg");var I=new o("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789");var J=new o(a.strShuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"));var O=function(Q,P){return Q!=null&&P>=0&&P<Q.length?Q.charAt(P):"0"
};var K=function(P){return P.indexOf("-")==0?"0"+P.substr(1):P};var L=function(P,S){var Q=0;for(var R=P.length;R<16;R++){P+=O(S,Q++)}return P};var M=function(P){return L(K(""+a.createHash(P)),K(""+a.createHash(P,true)))};this.checkOrigin=function(P){if(a.isFullStr(P)){return P=="null"||P=="http://msx.benzac.de"||P=="https://msx.benzac.de"||P=="ms-appx://52357benzac.de.mediastationx"||P=="http://localhost"||P.indexOf("http://localhost:")==0||P.indexOf("file://")==0}return false};this.transformString=function(P){return N.transformString(P)};this.normalizeString=function(P){return N.normalizeString(P)};this.createHashKey=function(P,Q){if(Q=="local"){return J.transformString(M(P))}return I.transformString(M(P))}};var s=new function(){var S=null;var Q=false;var P=function(V){if(S!=null){var T=S;S=null;if(T.length>0){for(var U=0;U<T.length;U++){T[U](V)}}}};var J=function(T){if(S==null){S=[]}S.push(T)};var N=function(U,T){if(a.isFullStr(T)){if(a.isFullStr(U)){return T==U}return false}return true
};var K=function(T){return T!=null&&T.info!=null&&T.info.framework!=null?a.strFullCheck(T.info.framework.name,null):null};var M=function(T){return T!=null&&T.info!=null&&T.info.framework!=null?a.strFullCheck(T.info.framework.version,null):null};var I=function(T){return T!=null&&T.info!=null&&T.info.application!=null?a.strFullCheck(T.info.application.name,null):null};var O=function(T){return T!=null&&T.info!=null&&T.info.application!=null?a.strFullCheck(T.info.application.version,null):null};var L=function(T){return T!=null&&T.info!=null&&T.info.content!=null?a.strFullCheck(T.info.content.name,null):null};var R=function(T){return T!=null&&T.info!=null&&T.info.content!=null?a.strFullCheck(T.info.content.version,null):null};this.createCanvas=function(V,U,T){return a.strReplace(l.COMMON.HTML.CANVAS.replace("{WIDTH}",a.strToNum(U,k.SCREEN_WIDTH)).replace("{HEIGHT}",a.strToNum(T,k.SCREEN_HEIGHT)),"{CLASS}",a.htmlAttrEscape(V))};this.createIFrame=function(T,U){return a.strReplace(a.strReplace(l.COMMON.HTML.IFRAME,"{CLASS}",a.htmlAttrEscape(T)),"{SRC}",a.htmlAttrEscape(a.strFullCheck(U,"about:blank")))
};this.areSettingsValidated=function(){return Q};this.invalidateSettings=function(){Q=false};this.validateSettings=function(aa){Q=true;var al=null;var V=null;var ac=null;var am=null;var ad=null;var ar=null;var aq=null;var ao=null;var W=null;var T=null;var Y=null;var ap=null;var ae=null;var ab=null;var aj=null;var an=null;var ag=null;var ak=null;var U=null;var ah=null;var af=null;var ai=null;var Z=null;var X=null;if(aa!=null&&aa.info!=null){aq=aa.info.platform;if(aa.info.time!=null){al=aa.info.time.offset;V=aa.info.time.zoneOffset}if(aa.info.screen!=null){ac=aa.info.screen.width;am=aa.info.screen.height;ad=aa.info.screen.factor;ar=aa.info.screen.zoomFactor}if(aa.info.framework!=null&&aa.info.framework.settings!=null){ao=aa.info.framework.settings.animate;W=aa.info.framework.settings.transform;T=aa.info.framework.settings.input;Y=aa.info.framework.settings.remote;ap=aa.info.framework.settings.layout;ae=aa.info.framework.settings.scale;ab=aa.info.framework.settings.zoom;aj=aa.info.framework.settings.center;
an=aa.info.framework.settings.background;ag=aa.info.framework.settings.exit;ak=aa.info.framework.settings.back;U=aa.info.framework.settings.volume;ah=aa.info.framework.settings.busy;af=aa.info.framework.settings.speed;ai=aa.info.framework.settings.playback;Z=aa.info.framework.settings.fullscreen;X=aa.info.framework.settings.suspend}}k.TIME_OFFSET=a.strToNum(al,k.TIME_OFFSET);k.TIME_ZONE_OFFSET=a.strToNum(V,k.TIME_ZONE_OFFSET);k.SCREEN_WIDTH=a.strToNum(ac,k.SCREEN_WIDTH);k.SCREEN_HEIGHT=a.strToNum(am,k.SCREEN_HEIGHT);k.SCREEN_FACTOR=a.strToNum(ad,k.SCREEN_FACTOR);k.ZOOM_FACTOR=a.strToNum(ar,k.ZOOM_FACTOR);k.PLATFORM=a.strFullCheck(aq,k.PLATFORM);k.ANIMATE=a.strToNum(ao,k.ANIMATE);k.TRANSFORM=a.strToNum(W,k.TRANSFORM);k.INPUT=a.strToNum(T,k.INPUT);k.REMOTE=a.strToNum(Y,k.REMOTE);k.LAYOUT=a.strFullCheck(ap,k.LAYOUT);k.SCALE=a.strFullCheck(ae,k.SCALE);k.ZOOM=a.strFullCheck(ab,k.ZOOM);k.CENTER=a.strToNum(aj,k.CENTER);k.BACKGROUND=a.strToNum(an,k.BACKGROUND);k.EXIT=a.strToNum(ag,k.EXIT);k.BACK=a.strToNum(ak,k.BACK);
k.VOLUME=a.strToNum(U,k.VOLUME);k.BUSY=a.strToNum(ah,k.BUSY);k.SPEED=a.strToNum(af,k.SPEED);k.PLAYBACK=a.strToNum(ai,k.PLAYBACK);k.FULLSCREEN=a.strToNum(Z,k.FULLSCREEN);k.SUSPEND=a.strToNum(X,k.SUSPEND);P(aa)};this.onValidatedSettings=function(T){if(typeof T=="function"){if(Q){T()}else{J(T)}}};this.handleSettingsEvent=function(U){if(U!=null&&a.isFullStr(U.event)&&U.event.indexOf("settings:")==0){var T=U.event.substr(9);if(T=="animate"){k.ANIMATE=a.strToNum(U.value,k.ANIMATE)}else{if(T=="transform"){k.TRANSFORM=a.strToNum(U.value,k.TRANSFORM)}else{if(T=="input"){k.INPUT=a.strToNum(U.value,k.INPUT)}else{if(T=="remote"){k.REMOTE=a.strToNum(U.value,k.REMOTE)}else{if(T=="layout"){k.LAYOUT=a.strToNum(U.value,k.LAYOUT)}else{if(T=="scale"){k.SCALE=a.strFullCheck(U.value,k.SCALE)}else{if(T=="zoom"){k.ZOOM=a.strFullCheck(U.value,k.ZOOM)}}}}}}}}};this.getFrameworkInfo=function(T){return a.strFullCheck(K(T),"-")+" "+a.strFullCheck(M(T),"-")};this.getApplicationInfo=function(T){return a.strFullCheck(I(T),"-")+" "+a.strFullCheck(O(T),"-")
};this.getContentInfo=function(T){return a.strFullCheck(L(T),"-")+" "+a.strFullCheck(R(T),"-")};this.checkFramework=function(V,U,T){return a.checkVersion(M(V),U)&&N(K(V),T)};this.checkApplication=function(V,U,T){return a.checkVersion(O(V),U)&&N(I(V),T)};this.checkContent=function(V,U,T){return a.checkVersion(R(V),U)&&N(L(V),T)};this.isSameContentState=function(U,T){return U!=null&&T!=null&&U.start===T.start&&U.restored===T.restored&&U.menuId===T.menuId&&U.menuFlag===T.menuFlag&&U.menuFocus===T.menuFocus&&U.menuIndex===T.menuIndex&&U.menuSize===T.menuSize&&U.contentId===T.contentId&&U.contentFlag===T.contentFlag&&U.contentFocus===T.contentFocus&&U.contentIndex===T.contentIndex&&U.contentSize===T.contentSize&&U.sceneVisible===T.sceneVisible&&U.sceneActive===T.sceneActive&&U.videoVisible===T.videoVisible&&U.videoActive===T.videoActive&&U.slideshowActive===T.slideshowActive&&U.overlayActive===T.overlayActive};this.createChangedContentState=function(U,T){return T!=null?{init:T.init,initChanged:U==null||U.init!==T.init,start:T.start,startChanged:U==null||U.start!==T.start,restored:T.restored,restoredChanged:U==null||U.restored!==T.restored,menuId:T.menuId,menuIdChanged:U==null||U.menuId!==T.menuId,menuFlag:T.menuFlag,menuFlagChanged:U==null||U.menuFlag!==T.menuFlag,menuFocus:T.menuFocus,menuFocusChanged:U==null||U.menuFocus!==T.menuFocus,menuIndex:T.menuIndex,menuIndexChanged:U==null||U.menuIndex!==T.menuIndex,menuSize:T.menuSize,menuSizeChanged:U==null||U.menuSize!==T.menuSize,contentId:T.contentId,contentIdChanged:U==null||U.contentId!==T.contentId,contentFlag:T.contentFlag,contentFlagChanged:U==null||U.contentFlag!==T.contentFlag,contentFocus:T.contentFocus,contentFocusChanged:U==null||U.contentFocus!==T.contentFocus,contentIndex:T.contentIndex,contentIndexChanged:U==null||U.contentIndex!==T.contentIndex,contentSize:T.contentSize,contentSizeChanged:U==null||U.contentSize!==T.contentSize,sceneVisible:T.sceneVisible,sceneVisibleChanged:U==null||U.sceneVisible!==T.sceneVisible,sceneActive:T.sceneActive,sceneActiveChanged:U==null||U.sceneActive!==T.sceneActive,videoVisible:T.videoVisible,videoVisibleChanged:U==null||U.videoVisible!==T.videoVisible,videoActive:T.videoActive,videoActiveChanged:U==null||U.videoActive!==T.videoActive,slideshowActive:T.slideshowActive,slideshowActiveChanged:U==null||U.slideshowActive!==T.slideshowActive,overlayActive:T.overlayActive,overlayActiveChanged:U==null||U.overlayActive!==T.overlayActive}:U
