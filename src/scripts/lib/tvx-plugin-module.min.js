...
}}}}else{if(L!=null){N();for(var Q=0;Q<L.length;Q++){var P=L.key(Q);if(P!=null&&P.indexOf(M)!=0){if(R(P,L.getItem(P))===true){break}}}}else{K.foreach(R)}}}};this.remove=function(P){if(a.isFullStr(P)){if(J!=null){delete J[P];delete J[M+P]}else{if(L!=null){L.removeItem(P);L.removeItem(M+P)}else{K.remove(P)}}}};this.clear=function(){if(J!=null){J={}}else{if(L!=null){L.clear()}else{K.clear()}}};this.setType=function(P){if(P=="cache"){J={};L=null}else{if(P=="storage"){J=null;L=window.localStorage}else{if(P=="cookies"){J=null;L=null}}}O()};this.getType=function(){if(J!=null){return"cache"}else{if(L!=null){return"storage"}}return"cookies"};O()}function A(J){var I=null;this.set=function(K,L){if(a.isFullStr(K)&&L!=null){if(I==null){I={}}I[K]=L}};this.get=function(K,L){if(I!=null&&a.isFullStr(K)&&I[K]!=null){return I[K]}return L!=null?L:null};this.getFullStr=function(K,L){return a.strFullCheck(this.get(K),L)};this.getNum=function(K,L){return a.strToNum(this.get(K),L)};this.getBool=function(K,L){return a.strToBool(this.get(K),L)
