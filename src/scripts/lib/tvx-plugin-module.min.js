/*
 * TVX Plugin v0.0.61 (Module)
 * (c) 2022 Benjamin Zachey
 * Compatibility: AMD and CommonJS
 */
(function(a,b){if(typeof define=="function"&&define.amd){define([],b)}else{if(typeof module=="object"&&module.exports){module.exports=b()}else{a.tvx=b()}}}(this,function(){var k={NAME:"TVX Framework",SHORTCUT:"TVX",VERSION:"0.1.29",SUFFIX:null,DUMMY_DATE:null,TIME_OFFSET:0,TIME_ZONE_OFFSET:0,ANIMATION_DURATION:300,ANIMATION_EASE:"easeOutQuad",AFK_DELAY:8000,SCREEN_WIDTH:1280,SCREEN_HEIGHT:720,SCREEN_FACTOR:1,ZOOM_FACTOR:1,PLATFORM:null,ID:null,ANIMATE:0,TRANSFORM:0,INPUT:0,REMOTE:0,LAYOUT:null,SCALE:null,ZOOM:null,CENTER:0,BACKGROUND:0,LEAVE:0,EXIT:0,BACK:0,VOLUME:0,BUSY:0,SPEED:0,PLAYBACK:0,FULLSCREEN:0,SUSPEND:0,SECURE:0,APP:null};var l={COMMON:{IMAGE:{DEFAULT:"img/default.png"},ICON:{DEFAULT:"blank"},TEXT:{DEFAULT:""},COLOR:{WHITE:"rgb(255,255,255)",WHITE_SOFT:"rgba(255,255,255,0.5)",BLACK:"rgb(0,0,0)",BLACK_SOFT:"rgba(0,0,0,0.5)",GRAY:"rgb(51,51,51)",GRAY_SOFT:"rgba(51,51,51,0.5)",RED:"rgb(201,48,44)",GREEN:"rgb(68,157,68)",YELLOW:"rgb(236,151,31)",BLUE:"rgb(49,176,213)",GLASS:"rgba(255,255,255,0.1)"},CSS:{CLASS_SELECTED:"selected",CLASS_TRIGGER:"trigger",CLASS_FOCUSED:"focused",CLASS_DISABLED:"disabled",CLASS_INVALIDATED:"invalidated",CLASS_HOVER:"hover",CLASS_ROOT:"tvx-root",CLASS_TOP_LAYER:"tvx-top-layer",CLASS_BOTTOM_LAYER:"tvx-bottom-layer",CLASS_FULLSCREEN:"tvx-fullscreen",CLASS_VIDEO:"tvx-video",CLASS_VIDEO_ON:"tvx-video-on",CLASS_CENTER_OFF:"tvx-center-off",CLASS_BACKGROUND_OFF:"tvx-background-off",CLASS_CLICK_THROUGH:"tvx-click-through",CLASS_CURSOR_OFF:"tvx-cursor-off",CLASS_FILLER:"tvx-filler",CLASS_FILLER_WIDTH_TOP:"tvx-filler-width-top",CLASS_FILLER_WIDTH_BOTTOM:"tvx-filler-width-bottom",CLASS_FILLER_WIDTH_CENTER:"tvx-filler-width-center",CLASS_FILLER_HEIGHT_LEFT:"tvx-filler-height-left",CLASS_FILLER_HEIGHT_RIGHT:"tvx-filler-height-right",CLASS_FILLER_HEIGHT_CENTER:"tvx-filler-height-center",CLASS_FILLER_FIT:"tvx-filler-fit",CLASS_FILLER_COVER:"tvx-filler-cover",CLASS_FILLER_SMART:"tvx-filler-smart",CLASS_ICON:"tvx-icon tvx-icon-{ICON}",CLASS_ICON_INLINE:"tvx-icon-inline tvx-icon-{ICON}",CLASS_TEXT:"tvx-text",CLASS_TEXT_INLINE:"tvx-text-inline"},HTML:{BREAK:"<br/>",SPACE:"&nbsp;",TAB:"&nbsp;&nbsp;&nbsp;",CANVAS:"<canvas class='{CLASS}' width='{WIDTH}' height='{HEIGHT}'></canvas>",IFRAME:"<iframe class='{CLASS}' frameBorder='0' scrolling='no' allow='autoplay *;encrypted-media *' src='{SRC}'></iframe>",ICON:"<i class='{CLASS}'></i>",ICON_STYLED:"<i class='{CLASS}' style='{STYLE}'></i>",TEXT:"<span class='{CLASS}'>{TEXT}</span>",TEXT_STYLED:"<span class='{CLASS}' style='{STYLE}'>{TEXT}</span>",TEXT_START:"<span class='{CLASS}'>",TEXT_START_STYLED:"<span class='{CLASS}' style='{STYLE}'>",TEXT_END:"</span>"}},LOGGER:{CSS:{CLASS_DEBUG:"tvx-debug",CLASS_INFO:"tvx-info",CLASS_WARN:"tvx-warn",CLASS_ERROR:"tvx-error"},HTML:{LINE:"<span class='{LEVEL}'>{MESSAGE}</span>"}},RENDERER:{CSS:{CLASS_TRANSFORM:"tvx-transform",CLASS_TRANSFORM_ZERO:"tvx-transform-zero",CLASS_TRANSFORM_3D:"tvx-transform-3d",CLASS_TRANSFORM_3D_ZERO:"tvx-transform-3d-zero"},STATE:{SHOW:{visible:true},HIDE:{visible:false},FADE_IN_FROM:{opacity:0},FADE_IN_TO:{opacity:1,visible:true},FADE_OUT_FROM:{opacity:1},FADE_OUT_TO:{opacity:0,visible:false}}},REMOTE:{CSS:{CLASS_BUTTON:"tvx-button",CLASS_SUBCONTROL_LEFT:"tvx-subcontrol-left",CLASS_SUBCONTROL_RIGHT:"tvx-subcontrol-right"}},APP:null};
var a=new function(){var O=/\\/g;var ab=/"/g;var Q=/'/g;var aw=/\n/g;var at=/\r/g;var M=/\r\n/g;var aq=/\t/g;var V=/\s/g;var Y=/-/g;var Z=/^[A-Za-z0-9._-]+$/;var aj=/[^,:{}\[\]0-9.\-+Eaeflnr-u \n\r\t]/;var ap=/"(\\.|[^"\\])*"/g;var ar=/^\s+|\s+$/g;var au=/^#?[A-Za-z0-9]+$/;var ac=/\s{0,}>\s{0,}/g;var ae=/\s{0,}\/>/g;var ad=/\s{0,}<\s{0,}/g;var ag=aw;var af=at;var ai=/\s{2,}/g;var I=/&/g;var U=ab;var N=Q;var aa=/</g;var S=/>/g;var am=/&quot;/g;var al=/&#39;/g;var ak=/&lt;/g;var ao=/&gt;/g;var an=/&amp;/g;var J=/\+/g;var L=/\//g;var K=/=/g;var P=/[^A-Za-z0-9\+\/\=]/g;var R=Y;var ah=/_/g;var ax=/,/g;var W=/\./g;var T="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";var X=window.location.protocol==="https:";var av=function(ay,aA){if(ay&&aA){var az=window.location.pathname;az=az.substring(0,az.lastIndexOf("/"));return window.location.protocol+"//"+window.location.host+az}else{if(ay){return window.location.protocol+"//"+window.location.host}}return window.location.protocol+"//"
};this.createVersion=function(aA){if(this.isFullStr(aA)){var aC=aA.split(".");if(aC.length==3){var az=this.strToNum(aC[0],-1);var ay=this.strToNum(aC[1],-1);var aB=this.strToNum(aC[2],-1);if(az>=0&&ay>=0&&aB>=0){return{major:az,minor:ay,patch:aB}}}}return null};this.checkVersion=function(aB,aA){var az=this.createVersion(aA);if(az!=null){var ay=this.createVersion(aB);if(ay!=null){if(ay.major==az.major){if(ay.minor==az.minor){return ay.patch>=az.patch}return ay.minor>az.minor}return ay.major>az.major}return false}return true};this.createKey=function(aC,aA){if(aC==null){aC=4}if(aA==null){aA=10}var az="";for(var aB=0;aB<aC;aB++){var ay=0;if(aA==0){ay=Math.round(Math.random()*9)}else{if(aA==1){ay=10+Math.round(Math.random()*51)}else{if(aA==2){ay=10+Math.round(Math.random()*25)}else{if(aA==3){ay=36+Math.round(Math.random()*25)}else{ay=Math.round(Math.random()*61)}}}}if(ay>=0&&ay<=9){az+=""+ay}if(ay>=10&&ay<=35){az+=String.fromCharCode(ay+55)}if(ay>=36&&ay<=61){az+=String.fromCharCode(ay+61)}}return az
};this.isFullStr=function(ay){return ay!=null&&typeof ay=="string"&&ay.length>0};this.isBool=function(ay){if(ay!=null&&typeof ay=="boolean"){return true}return this.isFullStr(ay)};this.isNum=function(ay){if(ay!=null&&typeof ay=="number"){return true}return this.isFullStr(ay)&&isFinite(ay)};this.isArray=function(ay){if(ay!=null){return Array.isArray(ay)}return false};this.isEmpty=function(az){if(az!=null){if(typeof az=="string"){return az.length==0}var ay;for(ay in az){return false}}return true};this.isValid=function(az,ay){if(az!=null){if(ay===true){if(typeof az=="string"){return az.length>0}}return true}return false};this.isId=function(ay){return this.isFullStr(ay)&&Z.test(ay)};this.isJson=function(ay){return this.isFullStr(ay)&&!aj.test(ay.replace(ap,""))};this.isHttpUrl=function(ay){return this.isFullStr(ay)&&(ay.indexOf("http://")==0||ay.indexOf("https://")==0)};this.strValue=function(ay){if(ay!=null){if(typeof ay=="string"){return ay}else{return""+ay}}return null};this.strFullCheck=function(az,ay){return this.isFullStr(az)?az:ay
};this.strTrim=function(ay){return this.isFullStr(ay)?ay.replace(ar,""):""};this.strClear=function(ay){return this.isFullStr(ay)?ay.replace(V,""):""};this.strTruncate=function(ay,az){return this.isFullStr(ay)&&az>0&&ay.length>az?ay.substr(0,az)+"...":ay};this.strShuffle=function(ay){return this.isFullStr(ay)?ay.split("").sort(function(){return 0.5-Math.random()}).join(""):""};this.strReplace=function(az,aA,ay){if(this.isFullStr(az)&&this.isFullStr(aA)){return az.replace(aA,function(){return ay!=null?ay:""})}return az};this.strReplaceMap=function(az,aA){if(this.isFullStr(az)&&aA!=null){for(var ay in aA){az=this.strReplace(az,ay,aA[ay])}}return az};this.strToBool=function(az,ay){if(az!=null&&typeof az=="boolean"){return az}return this.isFullStr(az)?az=="true":ay};this.strToNum=function(az,ay){if(az!=null&&typeof az=="number"){return az}return this.isFullStr(az)&&isFinite(az)?az*1:ay};this.strToAction=function(ay){return this.isFullStr(ay)?ay.toUpperCase().replace(Y,"_"):""};this.strToJsonStr=function(ay){return this.isFullStr(ay)?ay.replace(ab,'\\"'):""
};this.strToUrlStr=function(ay){return this.isFullStr(ay)?encodeURIComponent(ay):""};this.strContainsToken=function(aA,aB,ay,aC){if(this.isFullStr(aA)&&this.isFullStr(aB)){var az=aA.indexOf(aB);if(ay==null){ay=0}if(aC==null){aC=aA.length}return az>=ay&&az<aC}return false};this.strCountToken=function(aB,aC,az,aD){var ay=0;if(this.isFullStr(aB)&&this.isFullStr(aC)){var aA=0;if(az!=null&&az>=0){aA=az}while(aA>=0&&aA<aB.length){aA=aB.indexOf(aC,aA);if(aA>=0){aA+=aC.length;if(aD==null||aA<aD){ay++}}}}return ay};this.htmlTrim=function(ay){return this.isFullStr(ay)?this.strTrim(ay.replace(ac,">").replace(ae,"/>").replace(ad,"<").replace(ag," ").replace(af," ").replace(ai," ")):""};this.htmlEscape=function(ay){return this.isFullStr(ay)?ay.replace(I,"&amp;").replace(U,"&quot;").replace(N,"&#39;").replace(aa,"&lt;").replace(S,"&gt;"):""};this.htmlUnescape=function(ay){return this.isFullStr(ay)?ay.replace(am,'"').replace(al,"'").replace(ak,"<").replace(ao,">").replace(an,"&"):""};this.htmlAttrEscape=function(ay){return this.isFullStr(ay)?ay.replace(U,"&quot;").replace(N,"&#39;"):""
};this.htmlAttrUnescape=function(ay){return this.isFullStr(ay)?ay.replace(am,'"').replace(al,"'"):""};this.htmlTextEscape=function(ay){return this.isFullStr(ay)?this.htmlEscape(ay).replace(aw,l.COMMON.HTML.BREAK).replace(aq,l.COMMON.HTML.TAB):""};this.htmlCharacter=function(ay){return this.isFullStr(ay)&&au.test(ay)?"&"+ay+";":""};this.base64Encode=function(aG){var aB="";if(this.isFullStr(aG)){var aH,aC,aE;var aA,aF,az,aD;var ay=0;aG=this.utf8Encode(aG);while(ay<aG.length){aH=aG.charCodeAt(ay++);aC=aG.charCodeAt(ay++);aE=aG.charCodeAt(ay++);aA=aH>>2;aF=((aH&3)<<4)|(aC>>4);az=((aC&15)<<2)|(aE>>6);aD=aE&63;if(isNaN(aC)){az=aD=64}else{if(isNaN(aE)){aD=64}}aB+=T.charAt(aA)+T.charAt(aF)+T.charAt(az)+T.charAt(aD)}}return aB};this.base64EncodeUrl=function(ay){return this.isFullStr(ay)?this.base64Encode(ay).replace(J,"-").replace(L,"_").replace(K,","):""};this.base64EncodeId=function(ay){return this.isFullStr(ay)?this.base64Encode(ay).replace(J,"-").replace(L,"_").replace(K,"."):""};this.base64Decode=function(aG){var aB="";
if(this.isFullStr(aG)){var aH,aC,aE;var aA,aF,az,aD;var ay=0;aG=aG.replace(P,"");while(ay<aG.length){aA=T.indexOf(aG.charAt(ay++));aF=T.indexOf(aG.charAt(ay++));az=T.indexOf(aG.charAt(ay++));aD=T.indexOf(aG.charAt(ay++));aH=(aA<<2)|(aF>>4);aC=((aF&15)<<4)|(az>>2);aE=((az&3)<<6)|aD;aB+=String.fromCharCode(aH);if(az!=64){aB+=String.fromCharCode(aC)}if(aD!=64){aB+=String.fromCharCode(aE)}}}return this.utf8Decode(aB)};this.base64DecodeUrl=function(ay){return this.isFullStr(ay)?this.base64Decode(ay.replace(R,"+").replace(ah,"/").replace(ax,"=")):""};this.base64DecodeId=function(ay){return this.isFullStr(ay)?this.base64Decode(ay.replace(R,"+").replace(ah,"/").replace(W,"=")):""};this.utf8Encode=function(aB){var az="";if(this.isFullStr(aB)){aB=aB.replace(M,"\n");for(var ay=0;ay<aB.length;ay++){var aA=aB.charCodeAt(ay);if(aA<128){az+=String.fromCharCode(aA)}else{if((aA>127)&&(aA<2048)){az+=String.fromCharCode((aA>>6)|192);az+=String.fromCharCode((aA&63)|128)}else{az+=String.fromCharCode((aA>>12)|224);
az+=String.fromCharCode(((aA>>6)&63)|128);az+=String.fromCharCode((aA&63)|128)}}}}return az};this.utf8Decode=function(aC){var az="";if(this.isFullStr(aC)){var aD=0;var aA,aB,aE,ay;aA=aB=aE=ay=0;while(aD<aC.length){aA=aC.charCodeAt(aD);if(aA<128){az+=String.fromCharCode(aA);aD++}else{if((aA>191)&&(aA<224)){aE=aC.charCodeAt(aD+1);az+=String.fromCharCode(((aA&31)<<6)|(aE&63));aD+=2}else{aE=aC.charCodeAt(aD+1);ay=aC.charCodeAt(aD+2);az+=String.fromCharCode(((aA&15)<<12)|((aE&63)<<6)|(ay&63));aD+=3}}}}return az};this.createHash=function(aA,az){var ay=0;if(this.isFullStr(aA)){if(az===true){for(var aB=aA.length;aB>=0;aB--){ay=((ay<<5)-ay)+aA.charCodeAt(aB);ay&=ay}}else{for(var aB=0;aB<aA.length;aB++){ay=((ay<<5)-ay)+aA.charCodeAt(aB);ay&=ay}}}return ay};this.serialize=function(ay,aC){if(ay===undefined){return null}if(ay===null){if(aC!=null){return'"'+aC+'":null'}else{return"null"}}var aD=null;var aA=typeof ay;if(Array.isArray(ay)){aD="[";var aB=0;for(var aF=0;aF<ay.length;aF++){var az=this.serialize(ay[aF]);
if(az!=null){if(aB>0){aD+=","}aD+=az;aB++}}aD+="]"}else{if(aA=="object"){aD="{";var aB=0;for(var aE in ay){var az=this.serialize(ay[aE],aE);if(az!=null){if(aB>0){aD+=","}aD+=az;aB++}}aD+="}"}else{if(aA=="string"){aD='"'+ay.replace(O,"\\\\").replace(ab,'\\"').replace(aw,"\\n")+'"'}else{if(aA=="number"||aA=="boolean"){aD=""+ay}}}}if(aD!=null){if(aC!=null){return'"'+aC+'":'+aD}else{return aD}}return null};this.deserialize=function(ay){try{if(window.JSON!=null&&typeof JSON.parse=="function"){return this.isFullStr(ay)?JSON.parse(ay):null}else{return this.isJson(ay)?new Function("return "+ay)():null}}catch(az){return null}};this.isSecureContext=function(){return X};this.secureUrl=function(ay){return this.isFullStr(ay)?ay.replace("http://","https://"):ay};this.getPrefixUrl=function(ay){return av(false,false)+this.strFullCheck(ay,"")};this.getHostUrl=function(ay){return av(true,false)+"/"+this.strFullCheck(ay,"")};this.getPathUrl=function(ay){return av(true,true)+"/"+this.strFullCheck(ay,"")};this.getAbsoluteUrl=function(ay){if(this.isFullStr(ay)&&!this.isHttpUrl(ay)){if(ay.indexOf("/")==0){return av(true,false)+ay
}else{return av(true,true)+"/"+ay}}return ay};this.getRootPath=function(ay,aC){if(this.isFullStr(ay)){var aB=window.location.pathname;var aA=aB.indexOf(ay);if(aA>0){var az=aB.substr(0,aA);if(aC===true){if(az.indexOf("/")==0){az=az.substr(1)}if(az.lastIndexOf("/")==az.length-1){az=az.substr(0,az.length-1)}}else{if(az.indexOf("/")!=0){az="/"+az}if(az.lastIndexOf("/")!=az.length-1){az+="/"}}return az}}return aC===true?"":"/"};this.exprEscape=function(aF,aE,aK,aL,aG,aJ,aB){if(this.isFullStr(aF)&&typeof aL=="function"){if(this.isFullStr(aE)&&this.isFullStr(aK)&&typeof aG=="function"){if(aF.indexOf(aE)>=0&&aF.indexOf(aK)>=0){var ay="";var az=aE.length;var aD=aK.length;var aH=aF.length;var aI=0;var aC=0;var aA=0;while(aC>=0){aC=aF.indexOf(aE,aI);if(aC>=0){aA=aF.indexOf(aK,aC);if(aA>0){if(aI<aC){ay+=aL(aF.substring(aI,aC),aB)}if(aC+az<aA){ay+=aG(aF.substring(aC+az,aA),aB)}aI=aA+aD}else{aI=aC;break}}}if(aI<aH){ay+=aL(aF.substring(aI,aH),aB)}if(typeof aJ=="function"){ay+=aJ(aB)}return ay}}return aL(aF,aB)
...
};var Z=function(ac,af,ab){var ad=0;for(var ae=ac.length;ae<ab;ae++){ac+=O(af,ad++)}return ac};var P=function(ab){return Z(Q(""+a.createHash(ab)),Q(""+a.createHash(ab,true)),V)};var aa=function(ab){return a.isFullStr(ab)&&K.test(ab)};var R=function(ab){if(a.isFullStr(ab)&&ab.length<W){return Z(ab+"#",Q(""+a.createHash(ab))+Q(""+a.createHash(ab,true)),W)}return ab};var N=function(ab){return a.isFullStr(ab)?a.base64DecodeId(X.normalizeString(ab)):null};var L=function(ab){return a.isFullStr(ab)?X.transformString(a.base64EncodeId(R(ab))):null};var M=function(){z.storage.remove(I)};var J=function(ac){var ab=z.storage.getFullStr(I,null);if(!aa(N(ab))){ab=null}if(ab==null&&ac!=null&&ac.info!=null&&ac.info.platform!=null){ab=L(ac.info.platform+"_"+a.createKey(16)+"_"+g.getTimestamp());z.storage.set(I,ab)}return ab};var U=function(ab){if(ab!=null&&ab.info!=null&&ab.info.platform!=null&&ab.info.system!=null){if(ab.info.system.macAddress!=null){return L(ab.info.platform+"_"+ab.info.system.macAddress)
}else{if(ab.info.system.deviceId!=null){return L(ab.info.platform+"_"+ab.info.system.deviceId)}else{if(ab.info.id!=null){return L(ab.info.platform+"_"+ab.info.id)}}}}return J(ab)};this.checkOrigin=function(ab){if(a.isFullStr(ab)){return ab=="null"||ab=="http://msx.benzac.de"||ab=="https://msx.benzac.de"||ab=="ms-appx://52357benzac.de.mediastationx"||ab=="http://localhost"||ab.indexOf("http://localhost:")==0||ab.indexOf("file://")==0}return false};this.transformString=function(ab){return S.transformString(ab)};this.normalizeString=function(ab){return S.normalizeString(ab)};this.createHashKey=function(ab,ac){if(ac=="local"){return T.transformString(P(ab))}return Y.transformString(P(ab))};this.clearDeviceId=function(){M()};this.getDeviceId=function(ab){return U(ab)}};var s=new function(){var K=new b();var U=null;var R=false;var Q=function(X){if(U!=null){var V=U;U=null;if(V.length>0){for(var W=0;W<V.length;W++){V[W](X)}}}};var J=function(V){if(U==null){U=[]}U.push(V)};var O=function(W,V){if(a.isFullStr(V)){if(a.isFullStr(W)){return V==W
}return false}return true};var L=function(V){return V!=null&&V.info!=null&&V.info.framework!=null?a.strFullCheck(V.info.framework.name,null):null};var N=function(V){return V!=null&&V.info!=null&&V.info.framework!=null?a.strFullCheck(V.info.framework.version,null):null};var I=function(V){return V!=null&&V.info!=null&&V.info.application!=null?a.strFullCheck(V.info.application.name,null):null};var P=function(V){return V!=null&&V.info!=null&&V.info.application!=null?a.strFullCheck(V.info.application.version,null):null};var M=function(V){return V!=null&&V.info!=null&&V.info.content!=null?a.strFullCheck(V.info.content.name,null):null};var T=function(V){return V!=null&&V.info!=null&&V.info.content!=null?a.strFullCheck(V.info.content.version,null):null};var S=function(){K.start();K.start();window.addEventListener("load",function(){K.stop()});z.storage.onReady(function(){K.stop()})};this.createCanvas=function(X,W,V){return a.strReplace(l.COMMON.HTML.CANVAS.replace("{WIDTH}",a.strToNum(W,k.SCREEN_WIDTH)).replace("{HEIGHT}",a.strToNum(V,k.SCREEN_HEIGHT)),"{CLASS}",a.htmlAttrEscape(X))
};this.createIFrame=function(V,W){return a.strReplace(a.strReplace(l.COMMON.HTML.IFRAME,"{CLASS}",a.htmlAttrEscape(V)),"{SRC}",a.htmlAttrEscape(a.strFullCheck(W,"about:blank")))};this.isReady=function(){return !K.isBusy()};this.onReady=function(V){K.onReady(V)};this.startInitService=function(){K.start()};this.stopInitService=function(){K.stop()};this.areSettingsValidated=function(){return R};this.invalidateSettings=function(){R=false};this.validateSettings=function(ad){R=true;var al=null;var Y=null;var ao=null;var ap=null;var af=null;var ax=null;var aw=null;var am=null;var ar=null;var Z=null;var V=null;var ab=null;var at=null;var ag=null;var ae=null;var ai=null;var aq=null;var au=null;var X=null;var an=null;var W=null;var aj=null;var ah=null;var ak=null;var ac=null;var aa=null;var av=null;if(ad!=null&&ad.info!=null){aw=ad.info.platform;am=ad.info.id;if(ad.info.time!=null){al=ad.info.time.offset;Y=ad.info.time.zoneOffset}if(ad.info.screen!=null){ao=ad.info.screen.width;ap=ad.info.screen.height;
af=ad.info.screen.factor;ax=ad.info.screen.zoomFactor}if(ad.info.framework!=null&&ad.info.framework.settings!=null){ar=ad.info.framework.settings.animate;Z=ad.info.framework.settings.transform;V=ad.info.framework.settings.input;ab=ad.info.framework.settings.remote;at=ad.info.framework.settings.layout;ag=ad.info.framework.settings.scale;ae=ad.info.framework.settings.zoom;ai=ad.info.framework.settings.center;aq=ad.info.framework.settings.background;au=ad.info.framework.settings.leave;X=ad.info.framework.settings.exit;an=ad.info.framework.settings.back;W=ad.info.framework.settings.volume;aj=ad.info.framework.settings.busy;ah=ad.info.framework.settings.speed;ak=ad.info.framework.settings.playback;ac=ad.info.framework.settings.fullscreen;aa=ad.info.framework.settings.suspend;av=ad.info.framework.settings.secure}}k.TIME_OFFSET=a.strToNum(al,k.TIME_OFFSET);k.TIME_ZONE_OFFSET=a.strToNum(Y,k.TIME_ZONE_OFFSET);k.SCREEN_WIDTH=a.strToNum(ao,k.SCREEN_WIDTH);k.SCREEN_HEIGHT=a.strToNum(ap,k.SCREEN_HEIGHT);
k.SCREEN_FACTOR=a.strToNum(af,k.SCREEN_FACTOR);k.ZOOM_FACTOR=a.strToNum(ax,k.ZOOM_FACTOR);k.PLATFORM=a.strFullCheck(aw,k.PLATFORM);k.ID=a.strFullCheck(am,k.ID);k.ANIMATE=a.strToNum(ar,k.ANIMATE);k.TRANSFORM=a.strToNum(Z,k.TRANSFORM);k.INPUT=a.strToNum(V,k.INPUT);k.REMOTE=a.strToNum(ab,k.REMOTE);k.LAYOUT=a.strFullCheck(at,k.LAYOUT);k.SCALE=a.strFullCheck(ag,k.SCALE);k.ZOOM=a.strFullCheck(ae,k.ZOOM);k.CENTER=a.strToNum(ai,k.CENTER);k.BACKGROUND=a.strToNum(aq,k.BACKGROUND);k.LEAVE=a.strToNum(au,k.LEAVE);k.EXIT=a.strToNum(X,k.EXIT);k.BACK=a.strToNum(an,k.BACK);k.VOLUME=a.strToNum(W,k.VOLUME);k.BUSY=a.strToNum(aj,k.BUSY);k.SPEED=a.strToNum(ah,k.SPEED);k.PLAYBACK=a.strToNum(ak,k.PLAYBACK);k.FULLSCREEN=a.strToNum(ac,k.FULLSCREEN);k.SUSPEND=a.strToNum(aa,k.SUSPEND);k.SECURE=a.strToNum(av,k.SECURE);Q(ad)};this.onValidatedSettings=function(V){if(typeof V=="function"){if(R){V()}else{J(V)}}};this.handleSettingsEvent=function(W){if(W!=null&&a.isFullStr(W.event)&&W.event.indexOf("settings:")==0){var V=W.event.substr(9);
if(V=="animate"){k.ANIMATE=a.strToNum(W.value,k.ANIMATE)}else{if(V=="transform"){k.TRANSFORM=a.strToNum(W.value,k.TRANSFORM)}else{if(V=="input"){k.INPUT=a.strToNum(W.value,k.INPUT)}else{if(V=="remote"){k.REMOTE=a.strToNum(W.value,k.REMOTE)}else{if(V=="layout"){k.LAYOUT=a.strToNum(W.value,k.LAYOUT)}else{if(V=="scale"){k.SCALE=a.strFullCheck(W.value,k.SCALE)}else{if(V=="zoom"){k.ZOOM=a.strFullCheck(W.value,k.ZOOM)}}}}}}}}};this.getFrameworkInfo=function(V){return a.strFullCheck(L(V),"-")+" "+a.strFullCheck(N(V),"-")};this.getApplicationInfo=function(V){return a.strFullCheck(I(V),"-")+" "+a.strFullCheck(P(V),"-")};this.getContentInfo=function(V){return a.strFullCheck(M(V),"-")+" "+a.strFullCheck(T(V),"-")};this.checkFramework=function(X,W,V){return a.checkVersion(N(X),W)&&O(L(X),V)};this.checkApplication=function(X,W,V){return a.checkVersion(P(X),W)&&O(I(X),V)};this.checkContent=function(X,W,V){return a.checkVersion(T(X),W)&&O(M(X),V)};this.isSameContentState=function(W,V){return W!=null&&V!=null&&W.start===V.start&&W.restored===V.restored&&W.menuId===V.menuId&&W.menuFlag===V.menuFlag&&W.menuFocus===V.menuFocus&&W.menuIndex===V.menuIndex&&W.menuSize===V.menuSize&&W.contentId===V.contentId&&W.contentFlag===V.contentFlag&&W.contentFocus===V.contentFocus&&W.contentIndex===V.contentIndex&&W.contentSize===V.contentSize&&W.contentVisible===V.contentVisible&&W.panelId===V.panelId&&W.panelFlag===V.panelFlag&&W.panelFocus===V.panelFocus&&W.panelIndex===V.panelIndex&&W.panelSize===V.panelSize&&W.panelVisible===V.panelVisible&&W.videoVisible===V.videoVisible&&W.videoActive===V.videoActive&&W.playerVisible===V.playerVisible&&W.slideshowVisible===V.slideshowVisible&&W.volumeVisible===V.volumeVisible&&W.logVisible===V.logVisible
...
}};this.setupExtensionLabel=function(a6){if(aN){T("player:label:extension:"+a.strFullCheck(a6,"default"))}};this.setupPositionLabel=function(a6){if(aN){T("player:label:position:"+a.strFullCheck(a6,"default"))}};this.setupDurationLabel=function(a6){if(aN){T("player:label:duration:"+a.strFullCheck(a6,"default"))}};this.setupSpeedLabel=function(a6){if(aN){T("player:label:speed:"+a.strFullCheck(a6,"default"))}};this.setupInfoText=function(a6){if(aN){T("player:info:text:"+a.strFullCheck(a6,"default"))}};this.setupInfoImage=function(a6){if(aN){T("player:info:image:"+a.strFullCheck(a6,"default"))}};this.setupControlAction=function(a6){if(aN){T("player:control:action:"+a.strFullCheck(a6,"default"))}};this.setupButton=function(a6,a7){if(aN&&a.isId(a6)){T("player:button:"+a6+":setup",a7)}};this.enableButton=function(a6){if(aN&&a.isId(a6)){T("player:button:"+a6+":enable")}};this.disableButton=function(a6){if(aN&&a.isId(a6)){T("player:button:"+a6+":disable")}};this.focusButton=function(a6){if(aN&&a.isId(a6)){T("player:button:"+a6+":focus")
}};this.setupProgressColor=function(a6){if(aN){T("player:progress:color:"+a.strFullCheck(a6,"default"))}};this.setupProgressType=function(a6){if(aN){T("player:progress:type:"+a.strFullCheck(a6,"default"))}};this.enableProgressMarker=function(){if(aN){T("player:progress:marker:enable")}};this.disableProgressMarker=function(){if(aN){T("player:progress:marker:disable")}};this.invalidateProgressMarker=function(){if(aN){T("player:progress:marker:invalidate")}};this.setupBackground=function(a6){if(aN){T("player:background:"+a.strFullCheck(a6,"default"))}};this.setupTrigger=function(a6,a7,a8){if(aN&&a.isFullStr(a6)&&a.isFullStr(a7)){if(a8===true){T("trigger:"+a6+":shot:"+a7)}else{T("trigger:"+a6+":"+a7)}}};this.clearTrigger=function(a6){if(aN&&a.isFullStr(a6)){T("trigger:"+a6+":none")}};this.refreshPlayer=function(){if(aN){T("player:refresh")}};this.resetPlayer=function(){if(aN){T("player:reset")}};this.cancelResume=function(){if(aN){T("resume:cancel")}};this.requestData=function(a6,a8,a7){if(aN){ap(a6,a8,a7)
}else{W(a8,{error:"Plugin not ready"})}};this.requestInteractionResponse=function(a6,a8,a7){if(a.isFullStr(a6)){this.requestData("response:request:interaction:"+a6,a8,a7!=null?{requestData:a7}:null)}else{W(a8,{error:"Data ID is invalid: '"+a6+"'"})}};this.validateSettings=function(a6){s.invalidateSettings();this.requestData("info",function(a7){s.validateSettings(a7);W(a6,a7)})};this.onValidatedSettings=function(a6){if(!s.areSettingsValidated()&&!aM){aM=true;this.validateSettings(function(){aM=false})}s.onValidatedSettings(a6)};this.triggerEvent=function(a6,a7){if(aN&&a.isFullStr(a6)){T("event:"+a6,a7)}};this.setupSteam=function(a6){ad(a6)};this.createSteam=function(a6){return ao(a6)};this.resolveToken=function(a6,a7){return K(a6,a7)};this.transformString=function(a6,a7){return aE(a6,a7)};this.normalizeString=function(a6,a7){return ab(a6,a7)};this.transformStringAsync=function(a8,a9,a7){var a6=aE(a8,a9);if(a.isFullStr(a6)){this.requestData("string:transform:"+a6,function(ba){W(a7,{string:a.strFullCheck(ba.string,null)})
})}else{W(a7,{string:null})}};this.normalizeStringAsync=function(a7,a8,a6){if(a.isFullStr(a7)){this.requestData("string:normalize:"+a7,function(a9){W(a6,{string:ab(a9.string,a8)})})}else{W(a6,{string:null})}};this.createHashKey=function(a6,a7){return m.createHashKey(a6,a7)};this.clearDeviceId=function(){m.clearDeviceId()};this.getDeviceId=function(a6){return m.getDeviceId(a6)};this.requestDeviceId=function(a6){this.requestData("info:extended",function(a7){if(a7.error!=null){W(a6,{error:a7.error})}else{W(a6,{deviceId:m.getDeviceId(a7)})}})};this.hasContentObservers=function(){return aU.hasObservers()};this.addContentObserver=function(a6,a7){aU.addObserver(a6,a7);af(a6)};this.removeContentObserver=function(a6){aU.removeObserver(a6);af()};this.clearContentObservers=function(){aU.clear();af()};this.init=function(){if(!am){aH();aF();ag()}};this.commit=function(){if(aN){S();aY()}};this.isInitialized=function(){return am};this.isReady=function(){return aN};this.startPlayback=function(a6){if(aN){aR(y.PLAYING,true);
S();aY();if(a6===true){a2()}}};this.stopPlayback=function(){if(aN){this.setEnded(true);S();aa()}};this.cancelPlayback=function(){if(aN){T("player:eject")}};this.startLoading=function(){if(aN){aD.start(function(){P=true;T("player:busy:start:loading")})}};this.stopLoading=function(){if(aN){aD.stop();if(P){P=false;T("player:busy:stop:loading")}}}};var x=new function(){var L="interactionPlugin";var ap="irq";var af=10;var aI=30000;var X=new o("j3RZ!=Y$M5TZ#JPem'P1i(Tf?X3WcGlyCqNeXRbp02HL]I~r!IfO(pvxQ7At%9yq.5=)wm@0o?Js[sUbUH416uhd;_S/Qr,w7vW]jBgND;GazhCL+D%z~8ni+n-B_E-KK42tl[OAV@*E.Ya6$V,&kF)o&Mg98#'ucx/dk*SF");var Q=null;var P=false;var ar=new n(1000);var aA=false;var ah=false;var ab=null;var az=false;var aE=null;var Y=function(aM){Q=new o(aM)};var ai=function(aM){if(aA){if(aM=="local"){return Q!=null?Q.createSteam():null}return X.createSteam()}return null};var J=function(aM,aN){if(aA){if(aN=="local"){return Q!=null?Q.resolveToken(aM):null}return X.resolveToken(aM)}return null};var at=function(aM,aN){if(aA){if(aN=="local"){return Q!=null?Q.transformString(aM):null
}else{if(aN=="global"){return X.transformString(aM)}else{if(aN=="shared"){return m.transformString(Q!=null?Q.transformString(aM):aM)}}}return X.transformString(Q!=null?Q.transformString(aM):aM)}return null};var W=function(aM,aN){if(aA){if(aN=="local"){return Q!=null?Q.normalizeString(aM):null}else{if(aN=="global"){return X.normalizeString(aM)}else{if(aN=="shared"){return Q!=null?Q.normalizeString(m.normalizeString(aM)):m.normalizeString(aM)}}}return Q!=null?Q.normalizeString(X.normalizeString(aM)):X.normalizeString(aM)}return null};var aJ=0;var aD={};var ak=function(aO){aJ++;var aM=ap+aJ+"_"+g.getTimestamp();var aN={timeout:new n(aI),callback:aO};aD[aM]=aN;aN.timeout.start(function(){am(aM,{error:"Request timed out"})});return aM};var am=function(aM,aO){if(aM!=null){var aN=aD[aM];if(aN!=null){aN.timeout.stop();delete aD[aM];T(aN.callback,aO)}}};var T=function(aO,aM){if(typeof aO=="function"){try{aO(aM)}catch(aN){ad("Callback error",aN)}}};var aH=new h();var ac=new n(500);var an=null;var av=null;
var Z=function(aM){if(aM!=null){if(s.isSameContentState(an,aM)){if(!s.isSameContentState(av,aM)){if(av==null){aM.init=true}av=s.createChangedContentState(av,aM);aH.notifyObservers(av)}}else{an=aM}}aa()};var ay=function(){if(aA){aj("info:content",function(aM){Z(aM.info!=null&&aM.info.content!=null?aM.info.content.state:null)})}else{aa()}};var aa=function(aM){if(aH.hasObservers()){if(a.isFullStr(aM)&&av!=null){aH.notifyObserver(aM,av)}ac.start(ay)}else{an=null;av=null;ac.stop()}};var R=function(aM,aN){if(a.isFullStr(aM)){U({action:aM,data:aN!=null?aN:null})}};var au=function(aN,aM){if(a.isFullStr(aN)){if(aM!==false){R("logger:debug:"+aN)}}};var aq=function(aN,aM,aO){if(a.isFullStr(aN)){if(aM!==false){R("logger:success:"+aN,{show:aO!==false})}else{if(aO!==false){R("success:"+aN)}}}};var aL=function(aN,aM,aO){if(a.isFullStr(aN)){if(aM!==false){R("logger:info:"+aN,{show:aO!==false})}else{if(aO!==false){R("info:"+aN)}}}};var ae=function(aN,aM,aO){if(a.isFullStr(aN)){if(aM!==false){R("logger:warn:"+aN,{show:aO!==false})
}else{if(aO!==false){R("warn:"+aN)}}}};var al=function(aN,aM,aO){if(a.isFullStr(aN)){if(aM!==false){R("logger:error:"+aN,{show:aO!==false})}else{if(aO!==false){R("error:"+aN)}}}};var N=function(aM,aN){if(a.isFullStr(aM)&&aN!=null){if(typeof aN=="object"){R(aM+":data",aN)}else{R(aM+":"+aN)}}};var aC=function(aM){N("menu",aM)};var V=function(aM){N("content",aM)};var S=function(aM){N("panel",aM)};var aj=function(aM,aO,aN){if(a.isFullStr(aM)){if(aN==null){aN={}}aN.requestId=ak(aO);aN.dataId=aM;R("interaction:commit:"+aM,aN)}else{T(aO,{error:"Data ID is invalid: '"+aM+"'"})}};var ad=function(aM,aN){if(aM!=null&&aN!=null){if(aN.name!=null&&aN.message!=null){al("Interaction: "+aM+": "+aN.name+": "+aN.message)}else{al("Interaction: "+aM+": "+aN)}}};var ax=function(aM,aN){R("response:"+aM,aN)};var ag=function(aM,aN){am(aM,aN)};var I=function(aN,aM,aP){if(typeof ab.handleRequest=="function"){try{ab.handleRequest(aM,aP,function(aQ){ax(aN,aQ)})}catch(aO){ad("Handle request failed",aO);ax(aN)}}else{ax(aN)
}};var aK=function(aN){if(aA&&aN!=null&&ab!=null){if(typeof ab.handleEvent=="function"){try{ab.handleEvent(aN)}catch(aM){ad("Handle event failed",aM)}}}};var ao=function(aQ){if(aA&&aQ!=null&&ab!=null){if(a.isFullStr(aQ.requestId)&&a.isFullStr(aQ.dataId)){I(aQ.requestId,aQ.dataId,aQ.data)}else{if(aQ.data!=null&&a.isFullStr(aQ.data.requestId)&&a.isFullStr(aQ.data.dataId)){var aN={};var aP=aQ.data.dataId;var aM=aP.indexOf(":");if(aM>0){aP=aP.substr(0,aM)}aN[aP]=aQ[aP]!=null?aQ[aP]:null;aN.error=a.strFullCheck(aQ.error,null);ag(aQ.data.requestId,aN)}else{if(typeof ab.handleData=="function"){try{ab.handleData(aQ)}catch(aO){ad("Handle data failed",aO)}}}}}};var aF=function(aM){aE=aM!=null&&aM.length>0?aM:null};var O=function(){if(aE!=null&&aE.length>0){for(var aM=0;aM<aE.length;aM++){ao(aE[aM])}}aE=null};var aG=function(aM){if(aA&&aM!=null){if(aE==null){aE=[]}if(aE.length>=af){aE.shift()}aE.push(aM)}};var M=function(aM){if(!ah||aM===true){ah=true;if(ab!=null&&typeof ab.init=="function"){try{ab.init()
}catch(aN){ad("Call init failed",aN)}}}};var aB=function(aM){if(!aA||aM===true){aA=true;if(ab!=null&&typeof ab.ready=="function"){try{ab.ready()}catch(aN){ad("Call ready failed",aN)}}if(ab!=null){O()}}};var aw=function(){aA=false;window.addEventListener("message",function(aM){if(m.checkOrigin(aM.origin)){K(aM.data)}},false);R("interaction:init")};var K=function(aM){if(ah&&aM!=null&&aM.type===L){if(aM.init===1&&aA){return}if(aM.init===1){aF(aM.data);aB()}else{if(aM.data!=null){if(a.isFullStr(aM.data.event)){aK(aM.data)}else{if(ab!=null){ao(aM.data)}else{aG(aM.data)}}}}}};var U=function(aN){if(window.parent!=null&&aN!=null){aN.type=L;aN.sender="plugin";aN.target="app";try{window.parent.postMessage(aN,"*")}catch(aM){if(window.console!=null){console.error("Post message failed",aM)}}}};this.setupHandler=function(aM){ab=aM;if(ah){M(true)}if(aA){aB(true)}};this.setLoadingDelay=function(aM){ar.delay=a.strToNum(aM,ar.delay)};this.getLoadingDelay=function(){return ar.delay};this.executeAction=function(aM,aN){if(aA){R(aM,aN)
}};this.debug=function(aN,aM){if(aA){au(aN,aM)}};this.success=function(aN,aM,aO){if(aA){aq(aN,aM,aO)}};this.info=function(aN,aM,aO){if(aA){aL(aN,aM,aO)}};this.warn=function(aN,aM,aO){if(aA){ae(aN,aM,aO)}};this.error=function(aN,aM,aO){if(aA){al(aN,aM,aO)}};this.showMenu=function(aM){if(aA){aC(aM)}};this.showContent=function(aM){if(aA){V(aM)}};this.showPanel=function(aM){if(aA){S(aM)}};this.requestData=function(aM,aO,aN){if(aA){aj(aM,aO,aN)}else{T(aO,{error:"Plugin not ready"})}};this.requestPlayerResponse=function(aM,aO,aN){if(a.isFullStr(aM)){this.requestData("response:request:player:"+aM,aO,aN!=null?{requestData:aN}:null)}else{T(aO,{error:"Data ID is invalid: '"+aM+"'"})}};this.validateSettings=function(aM){s.invalidateSettings();this.requestData("info",function(aN){s.validateSettings(aN);T(aM,aN)})};this.onValidatedSettings=function(aM){if(!s.areSettingsValidated()&&!az){az=true;this.validateSettings(function(){az=false})}s.onValidatedSettings(aM)};this.triggerEvent=function(aM,aN){if(aA&&a.isFullStr(aM)){R("event:"+aM,aN)
}};this.setupSteam=function(aM){Y(aM)};this.createSteam=function(aM){return ai(aM)};this.resolveToken=function(aM,aN){return J(aM,aN)};this.transformString=function(aM,aN){return at(aM,aN)};this.normalizeString=function(aM,aN){return W(aM,aN)};this.transformStringAsync=function(aO,aP,aN){var aM=at(aO,aP);if(a.isFullStr(aM)){this.requestData("string:transform:"+aM,function(aQ){T(aN,{string:a.strFullCheck(aQ.string,null)})})}else{T(aN,{string:null})}};this.normalizeStringAsync=function(aN,aO,aM){if(a.isFullStr(aN)){this.requestData("string:normalize:"+aN,function(aP){T(aM,{string:W(aP.string,aO)})})}else{T(aM,{string:null})}};this.createHashKey=function(aM,aN){return m.createHashKey(aM,aN)};this.clearDeviceId=function(){m.clearDeviceId()};this.getDeviceId=function(aM){return m.getDeviceId(aM)};this.requestDeviceId=function(aM){this.requestData("info:extended",function(aN){if(aN.error!=null){T(aM,{error:aN.error})}else{T(aM,{deviceId:m.getDeviceId(aN)})}})};this.hasContentObservers=function(){return aH.hasObservers()
};this.addContentObserver=function(aM,aN){aH.addObserver(aM,aN);aa(aM)};this.removeContentObserver=function(aM){aH.removeObserver(aM);aa()};this.clearContentObservers=function(){aH.clear();aa()};this.init=function(){if(!ah){aw();M()}};this.isInitialized=function(){return ah};this.isReady=function(){return aA};this.startLoading=function(){if(aA){ar.start(function(){P=true;R("interaction:busy:start:loading")})}};this.stopLoading=function(){if(aA){ar.stop();if(P){P=false;R("interaction:busy:stop:loading")}}}};return{Settings:k,Styles:l,Tools:a,DateTools:g,DateFormatter:F,PropertyTools:D,VideoState:y,Action:f,Cookies:H,Storage:d,UrlParams:A,Options:e,Observers:h,EventObservers:G,Queue:w,Worker:c,Delay:n,Click:C,Ajax:j,LogLevel:r,Logger:u,Dictionary:p,Clock:i,DataLoader:t,Services:z,DataService:B,BlobService:q,RequestService:v,BusyService:b,PluginTools:s,VideoPlugin:E,InteractionPlugin:x}}));