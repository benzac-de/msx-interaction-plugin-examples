...
}};this.clear=function(){var J=this;this.foreach(function(K){J.set(K,"",I)})}}function d(){var X="exp:";var W=false;var I=0;var ac=null;var S=null;var P=null;var ae=new H();var af=new n(50);var ai=null;var Z=function(){if(ai!=null){var ak=ai;ai=null;if(ak.length>0){for(var aj=0;aj<ak.length;aj++){ak[aj]()}}}};var L=function(aj){if(ai==null){ai=[]}ai.push(aj)};var K=function(){if(!W){W=true;Z()}};var N=function(aj,ak){if(ak!=null){ak*=1;return ak>=0&&ak<aj}return false};var V=function(){if(I==4&&S!=null){P={};for(var ak=0;ak<S.length;ak++){var aj=S.key(ak);if(aj!=null){P[aj]=S.getItem(aj)}}}};var ah=function(ak){if(I==2){ac=ak!=null?ak:{}}else{if(I==4&&S!=null){P=ak!=null?ak:{};S.clear();if(ak!=null){for(var aj in ak){if(aj!=null){S.setItem(aj,ak[aj])}}}}}};var U=function(){if(I==2){return ac}else{if(I==4){return P}}return null};var T=function(){if((I==2||I==4)&&window.TVXStorageService!=null&&typeof TVXStorageService.pull=="function"){af.stop();TVXStorageService.pull(function(ak,aj){if(I==2||I==4){if(aj!=null){z.logger.error("Pull storage data failed: "+aj)
}ah(ak);K()}});return true}return false};var J=function(){if(W&&(I==2||I==4)&&window.TVXStorageService!=null&&typeof TVXStorageService.push=="function"){af.start(function(){TVXStorageService.push(U(),function(aj){if(aj!=null){z.logger.error("Push storage data failed: "+aj)}})});return true}return false};var R=function(){if(W&&(I==2||I==4)&&window.TVXStorageService!=null&&typeof TVXStorageService.clear=="function"){af.stop();TVXStorageService.clear(function(aj){if(aj!=null){z.logger.error("Clear storage data failed: "+aj)}});return true}return false};var ab=function(){try{S=window.localStorage}catch(aj){z.logger.warn("Access to local storage failed: "+aj);return false}return true};var M=function(){I=1;ac={};S=null;P=null;K()};var aa=function(){I=2;ac={};S=null;P=null;return T()};var Y=function(){I=3;ac=null;P=null;var aj=ab();if(aj){K()}return aj};var Q=function(){I=4;ac=null;S=null;P=null;if(window.TVXStorageService!=null){var aj=ab();if(aj&&S!=null){if(S.length>0){V();K();return true}else{return T()
}}}return false};var ag=function(){I=5;ac=null;S=null;P=null;K()};var O=function(){var al=[];var am=g.getTimestamp();if(ac!=null){for(var aj in ac){if(aj!=null&&aj.indexOf(X)==0){if(N(am,ac[aj])){al.push(aj.substr(X.length))}}}for(var ak=0;ak<al.length;ak++){delete ac[al[ak]];delete ac[X+al[ak]]}}else{if(S!=null){for(var ak=0;ak<S.length;ak++){var aj=S.key(ak);if(aj!=null&&aj.indexOf(X)==0){if(N(am,S.getItem(aj))){al.push(aj.substr(X.length))}}}for(var ak=0;ak<al.length;ak++){S.removeItem(al[ak]);S.removeItem(X+al[ak]);if(P!=null){delete P[al[ak]];delete P[X+al[ak]]}}}}};var ad=function(){if(!Q()){if(!aa()){if(!Y()){M()}}}};this.set=function(aj,am,al){if(a.isFullStr(aj)&&am!=null){var ak=-1;if(al!=null){if(typeof al=="number"){ak=new Date().getTime()+al}else{if(typeof al=="string"){ak=new Date(al).getTime()}else{if(typeof al.getTime=="function"){ak=al.getTime()}}}}if(ac!=null){ac[aj]=am;if(ak>=0){ac[X+aj]=ak}else{delete ac[X+aj]}J()}else{if(S!=null){S.setItem(aj,am);if(P!=null){P[aj]=am
}if(ak>=0){S.setItem(X+aj,ak);if(P!=null){P[X+aj]=ak}}else{S.removeItem(X+aj);if(P!=null){delete P[X+aj]}}J()}else{ae.set(aj,am,al)}}}};this.get=function(aj,am){if(a.isFullStr(aj)){if(ac!=null){var al=false;var ak=ac[X+aj];if(ak!=null){if(N(g.getTimestamp(),ak)){al=true;delete ac[aj];delete ac[X+aj]}}if(!al){var an=ac[aj];if(an!=null){return an}}}else{if(S!=null){var al=false;var ak=S.getItem(X+aj);if(ak!=null){if(N(g.getTimestamp(),ak)){al=true;S.removeItem(aj);S.removeItem(X+aj);if(P!=null){delete P[aj];delete P[X+aj]}}}if(!al){var an=S.getItem(aj);if(an!=null){return an}}}else{return ae.get(aj,am)}}}return am!=null?am:null};this.getFullStr=function(aj,ak){return a.strFullCheck(this.get(aj),ak)};this.getNum=function(aj,ak){return a.strToNum(this.get(aj),ak)};this.getBool=function(aj,ak){return a.strToBool(this.get(aj),ak)};this.has=function(aj,ak){return a.isValid(this.get(aj),ak)};this.foreach=function(al){if(typeof al=="function"){if(ac!=null){O();for(var aj in ac){if(aj!=null&&aj.indexOf(X)!=0){if(al(aj,ac[aj])===true){break
}}}}else{if(S!=null){O();for(var ak=0;ak<S.length;ak++){var aj=S.key(ak);if(aj!=null&&aj.indexOf(X)!=0){if(al(aj,S.getItem(aj))===true){break}}}}else{ae.foreach(al)}}}};this.remove=function(aj){if(a.isFullStr(aj)){if(ac!=null){delete ac[aj];delete ac[X+aj];J()}else{if(S!=null){S.removeItem(aj);S.removeItem(X+aj);if(P!=null){delete P[aj];delete P[X+aj]}J()}else{ae.remove(aj)}}}};this.clear=function(){if(ac!=null){ac={};R()}else{if(S!=null){S.clear();if(P!=null){P={}}R()}else{ae.clear()}}};this.flush=function(){af.finish()};this.getType=function(){if(ac!=null){return I==2?"service":"cache"}else{if(S!=null){return I==4?"hybrid":"default"}}return"cookies"};this.setType=function(aj){W=false;if(aj=="cache"){M()}else{if(aj=="service"){if(!aa()){M()}}else{if(aj=="default"){if(!Y()){M()}}else{if(aj=="hybrid"){if(!Q()){M()}}else{if(aj=="cookies"){ag()}else{K()}}}}}};this.isReady=function(){return W};this.onReady=function(aj){if(typeof aj=="function"){if(!W){L(aj)}else{aj()}}};ad()}function A(J){var I=null;
this.set=function(K,L){if(a.isFullStr(K)&&L!=null){if(I==null){I={}}I[K]=L}};this.get=function(K,L){if(I!=null&&a.isFullStr(K)&&I[K]!=null){return I[K]}return L!=null?L:null};this.getFullStr=function(K,L){return a.strFullCheck(this.get(K),L)};this.getNum=function(K,L){return a.strToNum(this.get(K),L)};this.getBool=function(K,L){return a.strToBool(this.get(K),L)};this.has=function(K,L){return a.isValid(this.get(K),L)};this.foreach=function(L){if(typeof L=="function"){if(I!=null){for(var K in I){if(L(K,I[K])===true){break}}}}};this.remove=function(K){if(I!=null&&a.isFullStr(K)){delete I[K]}};this.clear=function(){I={}};this.create=function(O){var N={};if(a.isFullStr(O)){var R=O.indexOf("?");if(R>=0){var M=O.substr(R+1).split("&");for(var K=0;K<M.length;K++){var P=M[K];if(a.isFullStr(P)){var L=P.indexOf("=");if(L>0){var Q=P.substr(0,L);var S=P.substr(L+1);N[decodeURIComponent(Q)]=decodeURIComponent(S)}else{N[decodeURIComponent(P)]=""}}}}}return N};this.build=function(N,M){var O=0;var K="";
if(I!=null){for(var L in I){var P=a.strValue(I[L]);if(O>0){K+=(M!=null?M:"&")}if(a.isFullStr(P)){K+=(N===false?L:encodeURIComponent(L))+"="+(N===false?P:encodeURIComponent(P))}else{K+=(N===false?L:encodeURIComponent(L))}O++}}return K};if(J!=null){I=this.create(J)}else{I=this.create(document.URL)}}function e(I,J){this.getValue=function(K){if(a.isFullStr(K)){if(I!=null&&I[K]!=null){return I[K]}if(J!=null&&J[K]!=null){return J[K]}}return null};this.get=function(K){return a.strValue(this.getValue(K))};this.getFullStr=function(K){return a.strFullCheck(this.get(K),null)};this.getNum=function(K){return a.strToNum(this.getValue(K),0)};this.getBool=function(K){return a.strToBool(this.getValue(K),false)};this.has=function(K,L){return a.isValid(this.get(K),L)}}function h(){var I={};this.hasObserver=function(J){return a.isFullStr(J)&&I[J]!=null};this.hasObservers=function(){var J;for(J in I){return true}return false};this.addObserver=function(J,K){if(a.isFullStr(J)&&typeof K=="function"){I[J]=K}};this.removeObserver=function(J){if(a.isFullStr(J)){delete I[J]
}};this.onEvent=function(J,K){if(a.isFullStr(J)){if(typeof K=="function"){this.addObserver(J,K)}else{this.removeObserver(J)}}};this.notifyObserver=function(J,K){if(a.isFullStr(J)&&I[J]!=null){I[J](K)}};this.notifyObservers=function(K){for(var J in I){I[J](K)}};this.clear=function(){I={}}}function G(){var I={};this.hasObserver=function(K,J){return a.isFullStr(K)&&a.isFullStr(J)&&I[K]!=null&&I[K][J]!=null};this.hasObservers=function(K){if(a.isFullStr(K)&&I[K]!=null){var J;for(J in I[K]){return true}}return false};this.addObserver=function(K,J,L){if(a.isFullStr(K)&&a.isFullStr(J)&&typeof L=="function"){if(I[K]==null){I[K]={}}I[K][J]=L}};this.removeObserver=function(K,J){if(a.isFullStr(K)&&a.isFullStr(J)&&I[K]!=null){delete I[K][J];if(!this.hasObservers(K)){delete I[K]}}};this.onEvent=function(K,J,L){if(a.isFullStr(K)&&a.isFullStr(J)){if(typeof L=="function"){this.addObserver(K,J,L)}else{this.removeObserver(K,J)}}};this.notifyObserver=function(K,J,L){if(a.isFullStr(K)&&a.isFullStr(J)&&I[K]!=null&&I[K][J]!=null){I[K][J](L)
...
var Z=new o("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789");var U=new o(a.strShuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"));var Y=new o("tuNiBAmqXwPd-aUIRFHn2YpVQ9gkD7zWC4jMGycJ8v65SrZ0.hO1eLfKboxEl3sT");var P=function(ad,ac){return ad!=null&&ac>=0&&ac<ad.length?ad.charAt(ac):"0"};var R=function(ac){return ac.indexOf("-")==0?"0"+ac.substr(1):ac};var aa=function(ad,ag,ac){var ae=0;for(var af=ad.length;af<ac;af++){ad+=P(ag,ae++)}return ad};var Q=function(ac){return aa(R(""+a.createHash(ac)),R(""+a.createHash(ac,true)),W)};var ab=function(ac){return a.isFullStr(ac)&&K.test(ac)};var S=function(ac){if(a.isFullStr(ac)&&ac.length<X){return aa(ac+"#",R(""+a.createHash(ac))+R(""+a.createHash(ac,true)),X)}return ac};var N=function(ac){return a.isFullStr(ac)?a.base64DecodeId(Y.normalizeString(ac)):null};var L=function(ac){return a.isFullStr(ac)?Y.transformString(a.base64EncodeId(S(ac))):null};var M=function(){z.storage.remove(I)};var J=function(ad){var ac=z.storage.getFullStr(I,null);
if(!ab(N(ac))){ac=null}if(ac==null&&ad!=null&&ad.info!=null&&ad.info.platform!=null){ac=L(ad.info.platform+"_"+a.createKey(16)+"_"+g.getTimestamp());z.storage.set(I,ac)}return ac};var V=function(ac){if(ac!=null&&ac.info!=null&&ac.info.platform!=null&&ac.info.system!=null){if(ac.info.system.macAddress!=null){return L(ac.info.platform+"_"+ac.info.system.macAddress)}else{if(ac.info.system.deviceId!=null){return L(ac.info.platform+"_"+ac.info.system.deviceId)}else{if(ac.info.id!=null){return L(ac.info.platform+"_"+ac.info.id)}}}}return J(ac)};this.checkOrigin=function(ac){if(a.isFullStr(ac)){return ac=="null"||ac=="http://msx.benzac.de"||ac=="https://msx.benzac.de"||ac=="ms-appx://52357benzac.de.mediastationx"||ac=="http://localhost"||ac.indexOf("http://localhost:")==0||ac.indexOf("file://")==0}return false};this.transformUrl=function(ac){return T.transformString(ac)};this.transformString=function(ac){return O.transformString(ac)};this.normalizeString=function(ac){return O.normalizeString(ac)
};this.createHashKey=function(ac,ad){if(ad=="local"){return U.transformString(Q(ac))}return Z.transformString(Q(ac))};this.clearDeviceId=function(){M()};this.getDeviceId=function(ac){return V(ac)}};var s=new function(){var L=new b();var V=null;var S=false;var O=null;var R=function(Y){if(V!=null){var W=V;V=null;if(W.length>0){for(var X=0;X<W.length;X++){W[X](Y)}}}};var K=function(W){if(V==null){V=[]}V.push(W)};var P=function(X,W){if(a.isFullStr(W)){if(a.isFullStr(X)){return W==X}return false}return true};var M=function(W){return W!=null&&W.info!=null&&W.info.framework!=null?a.strFullCheck(W.info.framework.name,null):null};var N=function(W){return W!=null&&W.info!=null&&W.info.framework!=null?a.strFullCheck(W.info.framework.version,null):null};var J=function(W){return W!=null&&W.info!=null&&W.info.application!=null?a.strFullCheck(W.info.application.name,null):null};var Q=function(W){return W!=null&&W.info!=null&&W.info.application!=null?a.strFullCheck(W.info.application.version,null):null
};var I=function(W){return W!=null&&W.info!=null&&W.info.content!=null?a.strFullCheck(W.info.content.name,null):null};var U=function(W){return W!=null&&W.info!=null&&W.info.content!=null?a.strFullCheck(W.info.content.version,null):null};var T=function(){L.start();L.start();window.addEventListener("load",function(){L.stop()});z.storage.onReady(function(){L.stop()})};this.createCanvas=function(Y,X,W){return a.strReplace(l.COMMON.HTML.CANVAS.replace("{WIDTH}",a.strToNum(X,k.SCREEN_WIDTH)).replace("{HEIGHT}",a.strToNum(W,k.SCREEN_HEIGHT)),"{CLASS}",a.htmlAttrEscape(Y))};this.createIFrame=function(W,X){return a.strReplace(a.strReplace(l.COMMON.HTML.IFRAME,"{CLASS}",a.htmlAttrEscape(W)),"{SRC}",a.htmlAttrEscape(a.strFullCheck(X,"about:blank")))};this.isReady=function(){return !L.isBusy()};this.onReady=function(W){L.onReady(W)};this.startInitService=function(){L.start()};this.stopInitService=function(){L.stop()};this.areSettingsValidated=function(){return S};this.invalidateSettings=function(){S=false;
O=null};this.validateSettings=function(ae){S=true;O=ae;var am=null;var Z=null;var ap=null;var aq=null;var ag=null;var az=null;var ay=null;var an=null;var au=null;var aa=null;var W=null;var ac=null;var av=null;var ah=null;var af=null;var aj=null;var ar=null;var aw=null;var Y=null;var ao=null;var X=null;var ak=null;var ai=null;var al=null;var ad=null;var ab=null;var ax=null;var at=null;if(ae!=null&&ae.info!=null){ay=ae.info.platform;an=ae.info.id;if(ae.info.time!=null){am=ae.info.time.offset;Z=ae.info.time.zoneOffset}if(ae.info.screen!=null){ap=ae.info.screen.width;aq=ae.info.screen.height;ag=ae.info.screen.factor;az=ae.info.screen.zoomFactor}if(ae.info.framework!=null&&ae.info.framework.settings!=null){au=ae.info.framework.settings.animate;aa=ae.info.framework.settings.transform;W=ae.info.framework.settings.input;ac=ae.info.framework.settings.remote;av=ae.info.framework.settings.layout;ah=ae.info.framework.settings.scale;af=ae.info.framework.settings.zoom;aj=ae.info.framework.settings.center;
ar=ae.info.framework.settings.background;aw=ae.info.framework.settings.leave;Y=ae.info.framework.settings.exit;ao=ae.info.framework.settings.back;X=ae.info.framework.settings.volume;ak=ae.info.framework.settings.busy;ai=ae.info.framework.settings.speed;al=ae.info.framework.settings.playback;ad=ae.info.framework.settings.fullscreen;ab=ae.info.framework.settings.suspend;ax=ae.info.framework.settings.secure;at=ae.info.framework.settings.caption}}k.TIME_OFFSET=a.strToNum(am,k.TIME_OFFSET);k.TIME_ZONE_OFFSET=a.strToNum(Z,k.TIME_ZONE_OFFSET);k.SCREEN_WIDTH=a.strToNum(ap,k.SCREEN_WIDTH);k.SCREEN_HEIGHT=a.strToNum(aq,k.SCREEN_HEIGHT);k.SCREEN_FACTOR=a.strToNum(ag,k.SCREEN_FACTOR);k.ZOOM_FACTOR=a.strToNum(az,k.ZOOM_FACTOR);k.PLATFORM=a.strFullCheck(ay,k.PLATFORM);k.ID=a.strFullCheck(an,k.ID);k.ANIMATE=a.strToNum(au,k.ANIMATE);k.TRANSFORM=a.strToNum(aa,k.TRANSFORM);k.INPUT=a.strToNum(W,k.INPUT);k.REMOTE=a.strToNum(ac,k.REMOTE);k.LAYOUT=a.strFullCheck(av,k.LAYOUT);k.SCALE=a.strFullCheck(ah,k.SCALE);
k.ZOOM=a.strFullCheck(af,k.ZOOM);k.CENTER=a.strToNum(aj,k.CENTER);k.BACKGROUND=a.strToNum(ar,k.BACKGROUND);k.LEAVE=a.strToNum(aw,k.LEAVE);k.EXIT=a.strToNum(Y,k.EXIT);k.BACK=a.strToNum(ao,k.BACK);k.VOLUME=a.strToNum(X,k.VOLUME);k.BUSY=a.strToNum(ak,k.BUSY);k.SPEED=a.strToNum(ai,k.SPEED);k.PLAYBACK=a.strToNum(al,k.PLAYBACK);k.FULLSCREEN=a.strToNum(ad,k.FULLSCREEN);k.SUSPEND=a.strToNum(ab,k.SUSPEND);k.SECURE=a.strToNum(ax,k.SECURE);k.CAPTION=a.strToNum(at,k.CAPTION);R(ae)};this.onValidatedSettings=function(W){if(typeof W=="function"){if(S){W(O)}else{K(W)}}};this.handleSettingsEvent=function(X){if(X!=null&&a.isFullStr(X.event)&&X.event.indexOf("settings:")==0){var W=X.event.substr(9);if(W=="animate"){k.ANIMATE=a.strToNum(X.value,k.ANIMATE)}else{if(W=="transform"){k.TRANSFORM=a.strToNum(X.value,k.TRANSFORM)}else{if(W=="input"){k.INPUT=a.strToNum(X.value,k.INPUT)}else{if(W=="remote"){k.REMOTE=a.strToNum(X.value,k.REMOTE)}else{if(W=="layout"){k.LAYOUT=a.strToNum(X.value,k.LAYOUT)}else{if(W=="scale"){k.SCALE=a.strFullCheck(X.value,k.SCALE)
}else{if(W=="zoom"){k.ZOOM=a.strFullCheck(X.value,k.ZOOM)}}}}}}}}};this.getFrameworkInfo=function(W){return a.strFullCheck(M(W),"-")+" "+a.strFullCheck(N(W),"-")};this.getApplicationInfo=function(W){return a.strFullCheck(J(W),"-")+" "+a.strFullCheck(Q(W),"-")};this.getContentInfo=function(W){return a.strFullCheck(I(W),"-")+" "+a.strFullCheck(U(W),"-")};this.checkFramework=function(Y,X,W){return a.checkVersion(N(Y),X)&&P(M(Y),W)};this.checkApplication=function(Y,X,W){return a.checkVersion(Q(Y),X)&&P(J(Y),W)};this.checkContent=function(Y,X,W){return a.checkVersion(U(Y),X)&&P(I(Y),W)};this.isSameContentState=function(X,W){return X!=null&&W!=null&&X.start===W.start&&X.restored===W.restored&&X.menuId===W.menuId&&X.menuFlag===W.menuFlag&&X.menuFocus===W.menuFocus&&X.menuIndex===W.menuIndex&&X.menuSize===W.menuSize&&X.contentId===W.contentId&&X.contentFlag===W.contentFlag&&X.contentFocus===W.contentFocus&&X.contentIndex===W.contentIndex&&X.contentSize===W.contentSize&&X.contentVisible===W.contentVisible&&X.panelId===W.panelId&&X.panelFlag===W.panelFlag&&X.panelFocus===W.panelFocus&&X.panelIndex===W.panelIndex&&X.panelSize===W.panelSize&&X.panelVisible===W.panelVisible&&X.videoVisible===W.videoVisible&&X.videoActive===W.videoActive&&X.playerVisible===W.playerVisible&&X.slideshowVisible===W.slideshowVisible&&X.volumeVisible===W.volumeVisible&&X.logVisible===W.logVisible
};this.createChangedContentState=function(X,W){return W!=null?{init:W.init,initChanged:X==null||X.init!==W.init,start:W.start,startChanged:X==null||X.start!==W.start,restored:W.restored,restoredChanged:X==null||X.restored!==W.restored,menuId:W.menuId,menuIdChanged:X==null||X.menuId!==W.menuId,menuFlag:W.menuFlag,menuFlagChanged:X==null||X.menuFlag!==W.menuFlag,menuFocus:W.menuFocus,menuFocusChanged:X==null||X.menuFocus!==W.menuFocus,menuIndex:W.menuIndex,menuIndexChanged:X==null||X.menuIndex!==W.menuIndex,menuSize:W.menuSize,menuSizeChanged:X==null||X.menuSize!==W.menuSize,contentId:W.contentId,contentIdChanged:X==null||X.contentId!==W.contentId,contentFlag:W.contentFlag,contentFlagChanged:X==null||X.contentFlag!==W.contentFlag,contentFocus:W.contentFocus,contentFocusChanged:X==null||X.contentFocus!==W.contentFocus,contentIndex:W.contentIndex,contentIndexChanged:X==null||X.contentIndex!==W.contentIndex,contentSize:W.contentSize,contentSizeChanged:X==null||X.contentSize!==W.contentSize,contentVisible:W.contentVisible,contentVisibleChanged:X==null||X.contentVisible!==W.contentVisible,panelId:W.panelId,panelIdChanged:X==null||X.panelId!==W.panelId,panelFlag:W.panelFlag,panelFlagChanged:X==null||X.panelFlag!==W.panelFlag,panelFocus:W.panelFocus,panelFocusChanged:X==null||X.panelFocus!==W.panelFocus,panelIndex:W.panelIndex,panelIndexChanged:X==null||X.panelIndex!==W.panelIndex,panelSize:W.panelSize,panelSizeChanged:X==null||X.panelSize!==W.panelSize,panelVisible:W.panelVisible,panelVisibleChanged:X==null||X.panelVisible!==W.panelVisible,videoVisible:W.videoVisible,videoVisibleChanged:X==null||X.videoVisible!==W.videoVisible,videoActive:W.videoActive,videoActiveChanged:X==null||X.videoActive!==W.videoActive,playerVisible:W.playerVisible,playerVisibleChanged:X==null||X.playerVisible!==W.playerVisible,slideshowVisible:W.slideshowVisible,slideshowVisibleChanged:X==null||X.slideshowVisible!==W.slideshowVisible,volumeVisible:W.volumeVisible,volumeVisibleChanged:X==null||X.volumeVisible!==W.volumeVisible,logVisible:W.logVisible,logVisibleChanged:X==null||X.logVisible!==W.logVisible}:X
