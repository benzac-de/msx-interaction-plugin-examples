...
var M=decodeURIComponent(K.substr(J+1));if(P(O,M)===true){break}}}}};this.remove=function(J){if(a.isFullStr(J)){this.set(J,"",I)}};this.clear=function(){var J=this;this.foreach(function(K){J.set(K,"",I)})}}function d(){var M="exp:";var J=null;var L=window.localStorage;var K=new H();var I=function(P,Q){if(Q!=null){Q*=1;return Q>=0&&Q<P}return false};var O=function(){if(L!=null){try{L.getItem("tvx")}catch(P){J={};L=null}}};var N=function(){var R=[];var S=g.getTimestamp();if(J!=null){for(var P in J){if(P!=null&&P.indexOf(M)==0){if(I(S,J[P])){R.push(P.substr(M.length))}}}for(var Q=0;Q<R.length;Q++){delete J[R[Q]];delete J[M+R[Q]]}}else{if(L!=null){for(var Q=0;Q<L.length;Q++){var P=L.key(Q);if(P!=null&&P.indexOf(M)==0){if(I(S,L.getItem(P))){R.push(P.substr(M.length))}}}for(var Q=0;Q<R.length;Q++){L.removeItem(R[Q]);L.removeItem(M+R[Q])}}}};this.set=function(P,S,R){if(a.isFullStr(P)&&S!=null){var Q=-1;if(R!=null){if(typeof R=="number"){Q=new Date().getTime()+R}else{if(typeof R=="string"){Q=new Date(R).getTime()
}else{if(typeof R.getTime=="function"){Q=R.getTime()}}}}if(J!=null){J[P]=S;if(Q>=0){J[M+P]=Q}else{delete J[M+P]}}else{if(L!=null){L.setItem(P,S);if(Q>=0){L.setItem(M+P,Q)}else{L.removeItem(M+P)}}else{K.set(P,S,R)}}}};this.get=function(P,S){if(a.isFullStr(P)){if(J!=null){var R=false;var Q=J[M+P];if(Q!=null){if(I(g.getTimestamp(),Q)){R=true;delete J[P];delete J[M+P]}}if(!R){var T=J[P];if(T!=null){return T}}}else{if(L!=null){var R=false;var Q=L.getItem(M+P);if(Q!=null){if(I(g.getTimestamp(),Q)){R=true;L.removeItem(P);L.removeItem(M+P)}}if(!R){var T=L.getItem(P);if(T!=null){return T}}}else{return K.get(P,S)}}}return S!=null?S:null};this.getFullStr=function(P,Q){return a.strFullCheck(this.get(P),Q)};this.getNum=function(P,Q){return a.strToNum(this.get(P),Q)};this.getBool=function(P,Q){return a.strToBool(this.get(P),Q)};this.has=function(P,Q){return a.isValid(this.get(P),Q)};this.foreach=function(R){if(typeof R=="function"){if(J!=null){N();for(var P in J){if(P!=null&&P.indexOf(M)!=0){if(R(P,J[P])===true){break
}}}}else{if(L!=null){N();for(var Q=0;Q<L.length;Q++){var P=L.key(Q);if(P!=null&&P.indexOf(M)!=0){if(R(P,L.getItem(P))===true){break}}}}else{K.foreach(R)}}}};this.remove=function(P){if(a.isFullStr(P)){if(J!=null){delete J[P];delete J[M+P]}else{if(L!=null){L.removeItem(P);L.removeItem(M+P)}else{K.remove(P)}}}};this.clear=function(){if(J!=null){J={}}else{if(L!=null){L.clear()}else{K.clear()}}};this.getType=function(){if(J!=null){return"cache"}else{if(L!=null){return"storage"}}return"cookies"};this.setType=function(P){if(P=="cache"){J={};L=null}else{if(P=="storage"){J=null;L=window.localStorage}else{if(P=="cookies"){J=null;L=null}}}O()};O()}function A(J){var I=null;this.set=function(K,L){if(a.isFullStr(K)&&L!=null){if(I==null){I={}}I[K]=L}};this.get=function(K,L){if(I!=null&&a.isFullStr(K)&&I[K]!=null){return I[K]}return L!=null?L:null};this.getFullStr=function(K,L){return a.strFullCheck(this.get(K),L)};this.getNum=function(K,L){return a.strToNum(this.get(K),L)};this.getBool=function(K,L){return a.strToBool(this.get(K),L)
};this.has=function(K,L){return a.isValid(this.get(K),L)};this.foreach=function(L){if(typeof L=="function"){if(I!=null){for(var K in I){if(L(K,I[K])===true){break}}}}};this.remove=function(K){if(I!=null&&a.isFullStr(K)){delete I[K]}};this.clear=function(){I={}};this.create=function(O){var N={};if(a.isFullStr(O)){var R=O.indexOf("?");if(R>=0){var M=O.substr(R+1).split("&");for(var K=0;K<M.length;K++){var P=M[K];if(a.isFullStr(P)){var L=P.indexOf("=");if(L>0){var Q=P.substr(0,L);var S=P.substr(L+1);N[decodeURIComponent(Q)]=decodeURIComponent(S)}else{N[decodeURIComponent(P)]=""}}}}}return N};this.build=function(N,M){var O=0;var K="";if(I!=null){for(var L in I){var P=a.strValue(I[L]);if(O>0){K+=(M!=null?M:"&")}if(a.isFullStr(P)){K+=(N===false?L:encodeURIComponent(L))+"="+(N===false?P:encodeURIComponent(P))}else{K+=(N===false?L:encodeURIComponent(L))}O++}}return K};if(J!=null){I=this.create(J)}else{I=this.create(document.URL)}}function e(I,J){this.getValue=function(K){if(a.isFullStr(K)){if(I!=null&&I[K]!=null){return I[K]
}if(J!=null&&J[K]!=null){return J[K]}}return null};this.get=function(K){return a.strValue(this.getValue(K))};this.getFullStr=function(K){return a.strFullCheck(this.get(K),null)};this.getNum=function(K){return a.strToNum(this.getValue(K),0)};this.getBool=function(K){return a.strToBool(this.getValue(K),false)};this.has=function(K,L){return a.isValid(this.get(K),L)}}function h(){var I={};this.hasObserver=function(J){return a.isFullStr(J)&&I[J]!=null};this.hasObservers=function(){var J;for(J in I){return true}return false};this.addObserver=function(J,K){if(a.isFullStr(J)&&typeof K=="function"){I[J]=K}};this.removeObserver=function(J){if(a.isFullStr(J)){delete I[J]}};this.onEvent=function(J,K){if(a.isFullStr(J)){if(typeof K=="function"){this.addObserver(J,K)}else{this.removeObserver(J)}}};this.notifyObserver=function(J,K){if(a.isFullStr(J)&&I[J]!=null){I[J](K)}};this.notifyObservers=function(K){for(var J in I){I[J](K)}};this.clear=function(){I={}}}function G(){var I={};this.hasObserver=function(K,J){return a.isFullStr(K)&&a.isFullStr(J)&&I[K]!=null&&I[K][J]!=null
};this.hasObservers=function(K){if(a.isFullStr(K)&&I[K]!=null){var J;for(J in I[K]){return true}}return false};this.addObserver=function(K,J,L){if(a.isFullStr(K)&&a.isFullStr(J)&&typeof L=="function"){if(I[K]==null){I[K]={}}I[K][J]=L}};this.removeObserver=function(K,J){if(a.isFullStr(K)&&a.isFullStr(J)&&I[K]!=null){delete I[K][J];if(!this.hasObservers(K)){delete I[K]}}};this.onEvent=function(K,J,L){if(a.isFullStr(K)&&a.isFullStr(J)){if(typeof L=="function"){this.addObserver(K,J,L)}else{this.removeObserver(K,J)}}};this.notifyObserver=function(K,J,L){if(a.isFullStr(K)&&a.isFullStr(J)&&I[K]!=null&&I[K][J]!=null){I[K][J](L)}};this.notifyObservers=function(K,L){if(a.isFullStr(K)&&I[K]!=null){for(var J in I[K]){I[K][J](L)}}};this.clear=function(J){if(a.isFullStr(J)){if(I[J]!=null){I[J]={}}}else{I={}}}}function w(){var J=null;var K=[];var I=null;var L=false;this.delegate=null;this.execute=function(){if(J!=null){clearTimeout(J);J=null}if(I!=null){if(typeof I.action=="function"){I.action()}else{if(this.delegate!=null&&typeof this.delegate.executeQueueAction=="function"){this.delegate.executeQueueAction(I.action)
}}I=null;this.process()}};this.process=function(){if(I==null&&K.length>0){I=K.shift();if(I.action==="stop"&&I.delay==null){L=true;I=null}else{if(I.delay!=null&&I.delay>0){var M=this;J=setTimeout(function(){J=null;M.execute()},I.delay)}else{this.execute()}}}};this.reset=function(){K=[];I=null;L=false;if(J!=null){clearTimeout(J);J=null}};this.push=function(M,N){if(M!=null){if(M==="reset"&&N==null){this.reset()}else{if(M==="execute"&&N==null){this.execute()}else{if(M==="clear"&&N==null){K=[]}else{if(M==="continue"&&N==null){L=false}else{K.push({action:M,delay:N})}}}}if(!L){this.process()}}};this.isBusy=function(){return J!=null}}function c(I,M){var K=null;var L=[];var J=0;this.size=I!=null?I:0;this.delay=M!=null?M:0;this.work=function(){if(K==null&&this.delay>0){var N=this;K=setTimeout(function(){K=null;J=0;N.process()},this.delay)}};this.process=function(){if(K==null&&L.length>0){if(J<this.size||this.size<=0||this.delay<=0){J++;var N=L.shift();N();this.process()}else{this.work()}}};this.reset=function(){L=[];
J=0;if(K!=null){clearTimeout(K);K=null}};this.execute=function(N){if(typeof N=="function"){L.push(N);this.process()}};this.isBusy=function(){return K!=null}}function n(L){var K=null;var J=null;var I=false;this.delay=L!=null?L:0;this.start=function(M){var N=this;I=false;this.stop();J=M;if(this.delay>0){K=setTimeout(function(){N.finish()},this.delay)}else{N.finish()}};this.restart=function(){this.start(J)};this.stop=function(){if(K!=null){clearTimeout(K);K=null}};this.finish=function(){this.stop();if(!I){I=true;if(typeof J=="function"){J()}}};this.isBusy=function(){return K!=null}}function C(){var K=300;var L=0;var I=0;var J=null;this.click=function(M){var N=g.getTimestamp();if(J===M&&L>0&&N-L<=K){I++}else{I=1}J=M;L=N;return I}}function j(){var I="application/json";var N="application/xml";var K="text/plain";var Q="text/html";var P="application/x-www-form-urlencoded";var L=function(T){var S=null;try{S=new XMLHttpRequest()}catch(R){if(T!=null&&typeof T.error=="function"){T.error("Create XML HTTP request failed: "+R)
}}return S};var O=function(R){if(R!=null&&typeof R.destroy=="function"){R.destroy()}};var M=function(V,W,T){var R=V.responseText;var U=true;if(R!=null){if(T==I){try{if(window.JSON!=null&&typeof JSON.parse=="function"){if(a.isFullStr(R)){R=JSON.parse(R)}else{U=false;if(W!=null&&typeof W.error=="function"){W.error("Validate JSON failed")}}}else{if(a.isJson(R)){R=new Function("return "+R)()}else{U=false;if(W!=null&&typeof W.error=="function"){W.error("Validate JSON failed")}}}}catch(S){U=false;if(W!=null&&typeof W.error=="function"){W.error("Create JSON failed: "+S)}}}else{if(T==N){R=V.responseXML}}}if(U&&W!=null&&typeof W.success=="function"){W.success(R)}};var J=function(X,U,W,ae,R){if(window.TVXAjaxService!=null&&typeof TVXAjaxService.executeRequest=="function"&&TVXAjaxService.executeRequest(X,U,W,ae,R)===true){return}var aa=L(ae);if(aa!=null){var ab=I;var V=false;var ac=false;var S=true;var ad=null;if(R!=null){V=R.isForm===true;ac=R.withCredentials===true;S=R.accurateHeaders!==false;ad=R.headers;
if(R.dataType!=null){if(R.dataType=="json"){ab=I}else{if(R.dataType=="xml"){ab=N}else{if(R.dataType=="text"){ab=K}else{if(R.dataType=="html"){ab=Q}else{ab=null}}}}}}try{if(ac){aa.withCredentials=true}aa.open(X,U,true)}catch(Z){O(aa);aa=null;if(ae!=null&&typeof ae.error=="function"){ae.error("Open connection failed: "+Z)}}if(aa!=null){aa.onreadystatechange=function(){if(aa!=null){if(aa.readyState==4){if((aa.status>=200&&aa.status<300)||(aa.status==0&&a.isFullStr(aa.responseText))){M(aa,ae,ab)}else{if(ae!=null&&typeof ae.error=="function"){var af=a.strValue(aa.status);if(a.isFullStr(aa.statusText)){af+=" "+aa.statusText}ae.error("Server responded with status: "+af)}}O(aa);aa=null}}};if(ab!=null){if(W!=null){aa.setRequestHeader("Content-Type",!V&&S?ab:P)}if(S){aa.setRequestHeader("Accept",ab)}}if(ad!=null){for(var Y in ad){var T=ad[Y];if(T!=null){aa.setRequestHeader(a.strValue(Y),a.strValue(T))}}}try{aa.send(W)}catch(Z){O(aa);aa=null;if(ae!=null&&typeof ae.error=="function"){ae.error("Send data failed: "+Z)
}}}}};this.get=function(R,T,S){J("GET",R,null,T,S)};this.post=function(S,U,R,T){J("POST",S,U,R,T)};this.put=function(S,U,R,T){J("PUT",S,U,R,T)};this.del=function(R,T,S){J("DELETE",R,null,T,S)}}var r={OFF:0,ERROR:1,WARN:2,INFO:3,DEBUG:4};function u(){var O=[];var K=null;this.level=r.DEBUG;this.maxLines=30;this.maxDebugLength=116;this.maxInfoLength=-1;this.maxWarnLength=-1;this.maxErrorLength=-1;var M=function(){var P=new Date();var W=P.getHours();var V=P.getMinutes();var T=P.getSeconds();var S=P.getMilliseconds();var R=P.getDate();var U=P.getMonth()+1;var Q=P.getFullYear();return Q+"-"+((U<10)?"0":"")+U+"-"+((R<10)?"0":"")+R+" "+((W<10)?"0":"")+W+":"+((V<10)?"0":"")+V+":"+((T<10)?"0":"")+T+"."+((S<10)?"00":((S<100)?"0":""))+S};var L=function(Q,P){var R="";switch(Q){case r.DEBUG:R=l.LOGGER.CSS.CLASS_DEBUG;break;case r.INFO:R=l.LOGGER.CSS.CLASS_INFO;break;case r.WARN:R=l.LOGGER.CSS.CLASS_WARN;break;case r.ERROR:R=l.LOGGER.CSS.CLASS_ERROR;break}return a.strReplace(l.LOGGER.HTML.LINE.replace("{LEVEL}",R),"{MESSAGE}",a.htmlEscape(P))
};var J=function(Q,P){var R="";switch(Q){case r.DEBUG:R="DEBUG";break;case r.INFO:R="INFO";break;case r.WARN:R="WARNING";break;case r.ERROR:R="ERROR";break}return M()+" "+R+": "+P};var I=function(R,Q,S,P){if(S>0&&Q.length>S){Q=Q.substr(0,S)+"..."}O.push(L(R,Q));if(P>0){while(O.length>P){O.shift()}}};var N=function(Q,P){if(window.console!=null){switch(Q){case r.DEBUG:console.log(P);break;case r.INFO:console.info(P);break;case r.WARN:console.warn(P);break;case r.ERROR:console.error(P);break}}};this.registerControl=function(P,Q){K=P;if(Q!==false){this.print()}};this.unregisterControl=function(P){if(K==P){K=null}};this.print=function(){if(K!=null&&O.length>0){var Q="";for(var P=0;P<O.length;P++){Q+=O[P]+l.COMMON.HTML.BREAK}K.html(Q)}};this.clear=function(){O=[];this.print()};this.log=function(Q,P){if(Q<=this.level){var R=-1;switch(Q){case r.DEBUG:R=this.maxDebugLength;break;case r.INFO:R=this.maxInfoLength;break;case r.WARN:R=this.maxWarnLength;break;case r.ERROR:R=this.maxErrorLength;break
}N(Q,P);I(Q,J(Q,P),R,this.maxLines);this.print()}};this.debug=function(P){this.log(r.DEBUG,P)};this.info=function(P){this.log(r.INFO,P)};this.warn=function(P){this.log(r.WARN,P)};this.error=function(P){this.log(r.ERROR,P)}}function p(){var L=null;var O=null;var N=0;var Q=null;var M=false;var K={};var P=function(R,S){K[R]=S;if(M){S()}};var I=function(R){delete K[R]};var J=function(){for(var R in K){K[R]()}};this.onReady=function(R,S){if(a.isFullStr(R)){if(typeof S=="function"){P(R,S)}else{I(R)}}};this.init=function(R){M=true;L=a.strFullCheck(R!=null?R.name:null,null);O=a.strFullCheck(R!=null?R.version:null,null);N=0;Q={};D.foreach(R,function(T,S){if(a.isFullStr(T)&&a.isFullStr(S)){Q[T]=S;N++}});J()};this.getName=function(){return L};this.getVersion=function(){return O};this.getSize=function(){return N};this.isInitialized=function(){return M};this.getValueForKey=function(S,R){if(Q!=null&&a.isFullStr(S)&&Q[S]!=null){return Q[S]}return R};this.getValueForExpr=function(S){if(a.isFullStr(S)){var R=S.indexOf("|");
if(R>0){return this.getValueForKey(S.substr(0,R),S.substr(R+1))}else{return this.getValueForKey(S,"")}}return""};this.getData=function(){return{name:L,version:O,size:N,properties:Q}}}function i(){var K=null;var L={};var J=null;var I=null;this.delay=0;this.now=g.getNow();this.format="time";this.isRunning=function(){return K!=null};this.hasHook=function(M){return a.isFullStr(M)&&L[M]!=null};this.hasHooks=function(){var M;for(M in L){return true}return false};this.hasControl=function(){return J!=null};this.clearHooks=function(){L={}};this.addHook=function(M,N){if(a.isFullStr(M)&&typeof N=="function"){L[M]=N}};this.removeHook=function(M){if(a.isFullStr(M)){delete L[M]}};this.onTick=function(M,N){if(a.isFullStr(M)){if(typeof N=="function"){this.addHook(M,N)}else{this.removeHook(M)}}};this.registerControl=function(M){J=M};this.unregisterControl=function(M){if(J==M){J=null}};this.update=function(){if(J!=null){var M=null;switch(this.format){case"full":M=F.toDayTimeFullStr(this.now);break;case"date":M=F.toDayTimeLongStr(this.now);
break;case"day":M=F.toTimeDayStr(this.now);break;case"time":M=F.toTimeStr(this.now);break;default:M="";break}if(J.clockText!=M){J.clockText=M;J.html(M)}}};this.validate=function(){this.now=g.getNow()};this.process=function(){if(K!=null){this.validate();this.delay=I!=null?this.now.getTime()-I.getTime():0;I=this.now;this.update();for(var M in L){L[M](this)}}};this.start=function(){if(K==null){var M=this;I=null;K=setInterval(function(){M.process()},1000)}};this.stop=function(){if(K!=null){clearInterval(K);K=null;I=null}}}var z={logger:new u(),cookies:new H(),storage:new d(),urlParams:new A(),ajax:new j()};var t=new function(){var I={};this.load=function(K,J,M,L){if(a.isFullStr(K)){if(J!=null&&I[J]!=null&&I[J].url==K&&I[J].data!=null){if(M!=null&&typeof M.success=="function"){M.success(I[J].data,true)}}else{z.ajax.get(K,{success:function(N){if(J!=null){I[J]={url:K,data:N}}if(M!=null&&typeof M.success=="function"){M.success(N,false)}},error:function(N){if(J!=null){I[J]={url:K,data:null}}if(M!=null&&typeof M.error=="function"){M.error(N)
}}},L)}}};this.clearCache=function(J){if(J!=null){I[J]=null}};this.clear=function(){I={}}};function B(){var U={};var N={};var R={};var O={};var Q=function(W){if(W!=null&&W.response!=null){return a.strToNum(W.response.status,0)}return 0};var V=function(W){if(W!=null&&W.response!=null){return W.response.data}return null};var L=function(X){var W="";if(X!=null&&X.response!=null){if(a.isNum(X.response.status)){W+=""+X.response.status}if(a.isFullStr(X.response.text)){if(W.length>0){W+=" "}W+=X.response.text}if(a.isFullStr(X.response.message)){if(W.length>0){W+=": "}W+=X.response.message}}return W.length>0?W:"Unknown error"};var T=function(W,X){R[W]=X;for(var Y in U){if(U[Y]!=null){X(U[Y])}}};var I=function(W){delete R[W]};var K=function(W){for(var X in R){R[X](W)}};var M=function(W,X){if(W!=null&&typeof X=="function"){O[W]=X;for(var Y in N){if(N[Y]!=null){X(N[Y])}}}};var S=function(W){if(W!=null){delete O[W]}};var J=function(W){for(var X in O){O[X](W)}};var P=function(W){return W!=null&&W.indexOf("temp:")!=0
};this.onReady=function(W,X){if(a.isFullStr(W)){if(typeof X=="function"){T(W,X)}else{I(W)}}};this.onError=function(W,X){if(a.isFullStr(W)){if(typeof X=="function"){M(W,X)}else{S(W)}}};this.onCompleted=function(W,X){this.onReady(W,X);this.onError(W,X)};this.foreachEntry=function(X){if(typeof X=="function"){for(var W in U){if(U[W]!=null){if(X(U[W])===true){break}}}}};this.foreachError=function(X){if(typeof X=="function"){for(var W in N){if(N[W]!=null){if(X(N[W])===true){break}}}}};this.getData=function(W){return W!=null&&U[W]!=null?U[W].data:null};this.getEntry=function(W){return W!=null?U[W]:null};this.setEntry=function(X,W){if(X!=null&&W!=null){U[X]=W;N[X]=null;K(W)}};this.getError=function(W){return W!=null?N[W]:null};this.setError=function(W,X){if(W!=null&&X!=null){U[W]=null;N[W]=X;J(X)}};this.shouldStoreData=function(W){return P(W)};this.createData=function(W,X){return X};this.putData=function(X,Z,W,Y){if(X!=null&&Z!=null){z.ajax.put(X,Z,{success:function(aa){if(aa.response!=null&&aa.response.status==200){if(W!=null&&typeof W.success=="function"){W.success(aa.response.data)
}}else{if(W!=null&&typeof W.error=="function"){W.error(L(aa),Q(aa),V(aa))}}},error:function(aa){if(W!=null&&typeof W.error=="function"){W.error(aa,0,null)}}},Y)}};this.postData=function(X,Z,W,Y){if(X!=null&&Z!=null){z.ajax.post(X,Z,{success:function(aa){if(aa.response!=null&&aa.response.status==200){if(W!=null&&typeof W.success=="function"){W.success(aa.response.data)}}else{if(W!=null&&typeof W.error=="function"){W.error(L(aa),Q(aa),V(aa))}}},error:function(aa){if(W!=null&&typeof W.error=="function"){W.error(aa,0,null)}}},Y)}};this.deleteData=function(W,Y,X){if(W!=null){z.ajax.del(W,{success:function(Z){if(Z.response!=null&&Z.response.status==200){if(Y!=null&&typeof Y.success=="function"){Y.success(Z.response.data)}}else{if(Y!=null&&typeof Y.error=="function"){Y.error(L(Z),Q(Z),V(Z))}}},error:function(Z){if(Y!=null&&typeof Y.error=="function"){Y.error(Z,0,null)}}},X)}};this.loadData=function(Z,X,aa,Y){if(Z!=null){var W=this;if(P(Z)){this.clearData(Z)}if(X!=null){z.ajax.get(X,{success:function(ae){var ad=false;
if(ae.response!=null&&ae.response.status==200&&ae.response.data!=null){ad=true;ae=ae.response.data}if(!ad&&ae.response!=null){var ab={id:Z,error:L(ae),status:Q(ae),reason:V(ae)};var ac=true;if(aa!=null&&typeof aa.error=="function"){ac=aa.error(ab)}if(ac!==false&&P(Z)){W.setError(Z,ab)}if(aa!=null&&typeof aa.completed=="function"){aa.completed(ab)}}else{var ab={id:Z,data:W.createData(Z,ae)};var ac=true;if(aa!=null&&typeof aa.success=="function"){ac=aa.success(ab)}if(ac!==false&&P(Z)){W.setEntry(Z,ab)}if(aa!=null&&typeof aa.completed=="function"){aa.completed(ab)}}},error:function(ad){var ab={id:Z,error:ad,status:0,reason:null};var ac=true;if(aa!=null&&typeof aa.error=="function"){ac=aa.error(ab)}if(ac!==false&&P(Z)){W.setError(Z,ab)}if(aa!=null&&typeof aa.completed=="function"){aa.completed(ab)}}},Y)}}};this.clearData=function(W){if(W!=null){U[W]=null;N[W]=null}};this.clear=function(){U={};N={}}}function q(){var N={};var Q={};var X={};var J={};var I=function(aa){if(aa!=null){try{if(window.URL!=null&&typeof URL.createObjectURL=="function"){return URL.createObjectURL(aa)
}else{if(window.webkitURL!=null&&typeof webkitURL.createObjectURL=="function"){return webkitURL.createObjectURL(aa)}}}catch(Z){z.logger.error("Create blob URL failed: "+Z)}}return null};var T=function(Z){if(Z!=null){try{if(window.URL!=null&&typeof URL.revokeObjectURL=="function"){URL.revokeObjectURL(Z)}else{if(window.webkitURL!=null&&typeof webkitURL.revokeObjectURL=="function"){webkitURL.revokeObjectURL(Z)}}}catch(aa){z.logger.error("Dispose blob URL failed: "+aa)}}};var Y=function(ab){var aa=null;try{aa=new XMLHttpRequest()}catch(Z){if(ab!=null&&typeof ab.error=="function"){ab.error("Create XML HTTP request failed: "+Z)}}return aa};var P=function(Z){if(Z!=null&&typeof Z.destroy=="function"){Z.destroy()}};var S=function(Z,aa){if(Z.response!=null){if(aa!=null&&typeof aa.success=="function"){aa.success(Z.response)}}else{if(aa!=null&&typeof aa.error=="function"){aa.error("Load blob failed: Response is missing")}}};var K=function(ad,ab,ac,aj,Z){var ag=Y(aj);if(ag!=null){var ah=false;var ai=null;
if(Z!=null){ah=Z.withCredentials===true;ai=Z.headers}try{if(ah){ag.withCredentials=true}ag.responseType="blob";ag.open(ad,ab,true)}catch(af){P(ag);ag=null;if(aj!=null&&typeof aj.error=="function"){aj.error("Open connection failed: "+af)}}if(ag!=null){ag.onreadystatechange=function(){if(ag!=null){if(ag.readyState==4){if(ag.status>=200&&ag.status<300){S(ag,aj)}else{if(aj!=null&&typeof aj.error=="function"){var ak=a.strValue(ag.status);if(a.isFullStr(ag.statusText)){ak+=" "+ag.statusText}aj.error("Server responded with status: "+ak)}}P(ag);ag=null}}};if(ai!=null){for(var ae in ai){var aa=ai[ae];if(aa!=null){ag.setRequestHeader(a.strValue(ae),a.strValue(aa))}}}try{ag.send(ac)}catch(af){P(ag);ag=null;if(aj!=null&&typeof aj.error=="function"){aj.error("Send data failed: "+af)}}}}};var M=function(Z,aa,ae,ac,af,ab,ad){if(ae!=null){Z.clearBlob(ae);if(ac!=null){K(aa,ac,af,{success:function(ah){var ag={id:ae,blob:ah,url:I(ah)};if(ab!=null&&typeof ab.success=="function"){ab.success(ag)}Z.setEntry(ae,ag);
if(ab!=null&&typeof ab.completed=="function"){ab.completed(ag)}},error:function(ah){var ag={id:ae,error:ah,status:0,reason:null};if(ab!=null&&typeof ab.error=="function"){ab.error(ag)}Z.setError(ae,ag);if(ab!=null&&typeof ab.completed=="function"){ab.completed(ag)}}},ad)}}};var L=function(Z,aa){X[Z]=aa;for(var ab in N){if(N[ab]!=null){aa(N[ab])}}};var O=function(Z){delete X[Z]};var R=function(Z){for(var aa in X){X[aa](Z)}};var V=function(Z,aa){if(Z!=null&&typeof aa=="function"){J[Z]=aa;for(var ab in Q){if(Q[ab]!=null){aa(Q[ab])}}}};var U=function(Z){if(Z!=null){delete J[Z]}};var W=function(Z){for(var aa in J){J[aa](Z)}};this.onReady=function(Z,aa){if(a.isFullStr(Z)){if(typeof aa=="function"){L(Z,aa)}else{O(Z)}}};this.onError=function(Z,aa){if(a.isFullStr(Z)){if(typeof aa=="function"){V(Z,aa)}else{U(Z)}}};this.onCompleted=function(Z,aa){this.onReady(Z,aa);this.onError(Z,aa)};this.foreachEntry=function(aa){if(typeof aa=="function"){for(var Z in N){if(N[Z]!=null){if(aa(N[Z])===true){break}}}}};
this.foreachError=function(aa){if(typeof aa=="function"){for(var Z in Q){if(Q[Z]!=null){if(aa(Q[Z])===true){break}}}}};this.getBlob=function(Z){return Z!=null&&N[Z]!=null?N[Z].blob:null};this.getUrl=function(Z){return Z!=null&&N[Z]!=null?N[Z].url:null};this.getEntry=function(Z){return Z!=null?N[Z]:null};this.setEntry=function(aa,Z){if(aa!=null&&Z!=null){T(N[aa]!=null?N[aa].url:null);N[aa]=Z;Q[aa]=null;R(Z)}};this.getError=function(Z){return Z!=null?Q[Z]:null};this.setError=function(Z,aa){if(Z!=null&&aa!=null){T(N[Z]!=null?N[Z].url:null);N[Z]=null;Q[Z]=aa;W(aa)}};this.executeBlob=function(ac,aa,ad,Z,ab){M(this,"POST",ac,aa,ad,Z,ab)};this.loadBlob=function(ab,Z,ac,aa){M(this,"GET",ab,Z,null,ac,aa)};this.clearBlob=function(Z){if(Z!=null){T(N[Z]!=null?N[Z].url:null);N[Z]=null;Q[Z]=null}};this.clear=function(){for(var Z in N){T(N[Z]!=null?N[Z].url:null)}N={};Q={}}}function v(N){var K="srq";var J=0;var I={};var O=0;this.timeout=N!=null?N:30000;var L=function(P,S){J++;O++;var R=K+J+"_"+g.getTimestamp();
var Q={timeout:new n(P),callback:S};I[R]=Q;Q.timeout.start(function(){M(R,null,"Request timed out","timeout")});return R};var M=function(S,T,P,Q){if(S!=null){var R=I[S];if(R!=null){O--;R.timeout.stop();delete I[S];if(P!=null){if(R.callback!=null&&typeof R.callback.error=="function"){R.callback.error(P,Q)}}else{if(R.callback!=null&&typeof R.callback.success=="function"){R.callback.success(T)}}}}};this.startRequest=function(P){return L(this.timeout,P)};this.getRequestsCount=function(){return O};this.isRequestPending=function(P){return P!=null&&I[P]!=null};this.handleData=function(P,Q){M(P,Q!=null?Q:null,null)};this.handleError=function(Q,R,P){M(Q,null,R!=null?R:"Unknown error",P!=null?P:null)}}function b(){var L=0;var K=null;var J=function(){if(K!=null){var N=K;K=null;if(N.length>0){for(var M=0;M<N.length;M++){N[M]()}}}};var I=function(M){if(K==null){K=[]}K.push(M)};this.isBusy=function(){return L>0};this.start=function(M){if(M===true){L=1}else{L++}};this.stop=function(M){if(L>0){if(M===true){L=0
}else{if(L>0){L--}}if(L==0){J()}}};this.onReady=function(M){if(typeof M=="function"){if(L>0){I(M)}else{M()}}}}function o(S){var T=4;var Q=256;var U=null;var R=null;var ab=function(al){return a.isFullStr(al)&&al.length>=T&&al.length<Q&&al.length%2==0};var ag=function(al){return al&al};var J=function(al,am){return ag(((al<<5)-al)+am)};var W=function(al){return al.length==1?"0"+al:al};var ad=function(am,al){if(al>0){while(am<0){am+=al}while(am>=al){am-=al}}return am};var Z=function(an,am,al){an+=3;return an+am>=al?0:an};var M=function(al,am){al++;return al>=am?0:al};var aa=function(al,am){return am?-al:al};var ah=function(ao,ap,an,al,am){return ad(ap+aa(al,am)*ac(ao,an),Q)};var O=function(ar,al,aq,at,am,ap,an){var ao=ar!=null&&aq!=null?ar.indexOf(aq):-1;return ao>=0?aj(ar,ad(ao+aa(ap,an)*(at+ac(al,am)),ar.length)):aq};var N=function(am,al){return al!=null?(am!=null?am+al:al):am};var aj=function(al,am){return al!=null&&am>=0&&am<al.length?al.charAt(am):null};var ac=function(al,am){return al!=null&&am>=0&&am<al.length?al.charCodeAt(am):0
};var P=function(aq,at,al,ap,am,ao){var ar=aj(aq,ap);if(ar!=null){var an=Math.random()>0.5?at.indexOf(ar):at.lastIndexOf(ar);return an>=0?W(ah(al,an,am,1,ao).toString(16)):null}return null};var K=function(aq,al,ap,am,ao){var at=aj(aq,ap);var ar=aj(aq,ap+1);var an=at!=null&&ar!=null?parseInt(at+ar,16):-1;return an>=0?ah(al,an,am,-1,ao):-1};var ai=function(ar,aw,am){var av=null;if(a.isFullStr(ar)&&ar.length%2==0&&ab(aw)&&ab(am)){var aq=ar.length;var at=am.length;var an=0;var ap=0;var ao=false;for(var al=0;al<aq;al+=2){var au=aj(aw,K(ar,am,al,an+ap,ao));if(au!=null){av=N(av,au)}else{return null}an=Z(an,ap,at);if(an==0){ap=M(ap,at)}ao=!ao}}return av};var L=function(at,ao,am){var aw=null;if(a.isFullStr(at)&&ab(ao)&&ab(am)){var av=at.length;var au=am.length;var an=0;var ar=0;var aq=false;for(var al=0;al<av;al++){var ap=P(at,ao,am,al,an+ar,aq);if(ap!=null){aw=N(aw,ap)}else{return null}an=Z(an,ar,au);if(an==0){ar=M(ar,au)}aq=!aq}}return aw};var ak=function(am){var al=am<0?-1:1;return al*((am*al)%Q)
};var ae=function(ap){var am=null;if(ab(ap)){var ao=ap.length;var an=ao/2;for(var aq=0;aq<an;aq++){var ar=aj(ap,aq);var al=aj(ap,ao-1-aq);if(am==null||am.indexOf(ar)<0){am=N(am,ar)}if(am.indexOf(al)<0){am=N(am,al)}}}return am};var I=function(ao,aq,ap){var an=0;if(ao!=null&&aq!=null&&ap!=null){var ar=ao.length;var al=ap.length;an=ar;for(var am=0;am<al;am++){an=J(an,ac(ap,am))}for(var am=0;am<ar;am++){if(aq.indexOf(aj(ao,am))<0){an=J(an,ac(ao,am))}}}return ak(an)};var V=function(at,aw,am,au){var ao=null;if(a.isFullStr(at)&&ab(aw)&&ab(am)){var ax=I(at,aw,am);var av=at.length;var ar=am.length;var an=0;var aq=0;var ap=false;for(var al=0;al<av;al++){ao=N(ao,O(aw,am,aj(at,al),ax,an+aq,au,ap));an=Z(an,aq,ar);if(an==0){aq=M(aq,ar)}ap=!ap}}return ao};var af=function(){return L(a.strShuffle(S),S,S)};var X=function(al,am){return ai(al,ai(am,S,S),S)};var Y=function(){if(R==null){R=ae(S)}return R};this.createSteam=function(){U=af();return U};this.resolveToken=function(al){return X(al,U)};this.transformString=function(al){return V(al,Y(),S,1)
};this.normalizeString=function(al){return V(al,Y(),S,-1)}}var m=new function(){var V=16;var W=32;var I="tvx:device_id";var K=/^[a-z-]+_[A-Za-z0-9]+_[0-9]+([0-9#])*$/;var S=new o("k%hy.nLI1&4rN[D9YAPVCu(*&5F)'aC$=frs,wocT48qpRpXt[Gx$BQZU@B,9N;oL%j*J~hXbW)-#q#z7+0uMgHm3fEHcdK@iIG!?nP!/Y.3vFb~2eUz(sk-O/W?AtJ_VT_8]=+K;DmS6Q1iSx60]jaevER'l7y5ZlOdM2wg");var Y=new o("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789");var T=new o(a.strShuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"));var X=new o("tuNiBAmqXwPd-aUIRFHn2YpVQ9gkD7zWC4jMGycJ8v65SrZ0.hO1eLfKboxEl3sT");var O=function(ac,ab){return ac!=null&&ab>=0&&ab<ac.length?ac.charAt(ab):"0"};var Q=function(ab){return ab.indexOf("-")==0?"0"+ab.substr(1):ab};var Z=function(ac,af,ab){var ad=0;for(var ae=ac.length;ae<ab;ae++){ac+=O(af,ad++)}return ac};var P=function(ab){return Z(Q(""+a.createHash(ab)),Q(""+a.createHash(ab,true)),V)};var aa=function(ab){return a.isFullStr(ab)&&K.test(ab)};var R=function(ab){if(a.isFullStr(ab)&&ab.length<W){return Z(ab+"#",Q(""+a.createHash(ab))+Q(""+a.createHash(ab,true)),W)
}return ab};var N=function(ab){return a.isFullStr(ab)?a.base64DecodeId(X.normalizeString(ab)):null};var L=function(ab){return a.isFullStr(ab)?X.transformString(a.base64EncodeId(R(ab))):null};var M=function(){z.storage.remove(I)};var J=function(ac){var ab=z.storage.getFullStr(I,null);if(!aa(N(ab))){ab=null}if(ab==null&&ac!=null&&ac.info!=null&&ac.info.platform!=null){ab=L(ac.info.platform+"_"+a.createKey(16)+"_"+g.getTimestamp());z.storage.set(I,ab)}return ab};var U=function(ab){if(ab!=null&&ab.info!=null&&ab.info.platform!=null&&ab.info.system!=null){if(ab.info.system.macAddress!=null){return L(ab.info.platform+"_"+ab.info.system.macAddress)}else{if(ab.info.system.deviceId!=null){return L(ab.info.platform+"_"+ab.info.system.deviceId)}else{if(ab.info.id!=null){return L(ab.info.platform+"_"+ab.info.id)}}}}return J(ab)};this.checkOrigin=function(ab){if(a.isFullStr(ab)){return ab=="null"||ab=="http://msx.benzac.de"||ab=="https://msx.benzac.de"||ab=="ms-appx://52357benzac.de.mediastationx"||ab=="http://localhost"||ab.indexOf("http://localhost:")==0||ab.indexOf("file://")==0
}return false};this.transformString=function(ab){return S.transformString(ab)};this.normalizeString=function(ab){return S.normalizeString(ab)};this.createHashKey=function(ab,ac){if(ac=="local"){return T.transformString(P(ab))}return Y.transformString(P(ab))};this.clearDeviceId=function(){M()};this.getDeviceId=function(ab){return U(ab)}};var s=new function(){var S=null;var Q=false;var P=function(V){if(S!=null){var T=S;S=null;if(T.length>0){for(var U=0;U<T.length;U++){T[U](V)}}}};var J=function(T){if(S==null){S=[]}S.push(T)};var N=function(U,T){if(a.isFullStr(T)){if(a.isFullStr(U)){return T==U}return false}return true};var K=function(T){return T!=null&&T.info!=null&&T.info.framework!=null?a.strFullCheck(T.info.framework.name,null):null};var M=function(T){return T!=null&&T.info!=null&&T.info.framework!=null?a.strFullCheck(T.info.framework.version,null):null};var I=function(T){return T!=null&&T.info!=null&&T.info.application!=null?a.strFullCheck(T.info.application.name,null):null};var O=function(T){return T!=null&&T.info!=null&&T.info.application!=null?a.strFullCheck(T.info.application.version,null):null
};var L=function(T){return T!=null&&T.info!=null&&T.info.content!=null?a.strFullCheck(T.info.content.name,null):null};var R=function(T){return T!=null&&T.info!=null&&T.info.content!=null?a.strFullCheck(T.info.content.version,null):null};this.createCanvas=function(V,U,T){return a.strReplace(l.COMMON.HTML.CANVAS.replace("{WIDTH}",a.strToNum(U,k.SCREEN_WIDTH)).replace("{HEIGHT}",a.strToNum(T,k.SCREEN_HEIGHT)),"{CLASS}",a.htmlAttrEscape(V))};this.createIFrame=function(T,U){return a.strReplace(a.strReplace(l.COMMON.HTML.IFRAME,"{CLASS}",a.htmlAttrEscape(T)),"{SRC}",a.htmlAttrEscape(a.strFullCheck(U,"about:blank")))};this.areSettingsValidated=function(){return Q};this.invalidateSettings=function(){Q=false};this.validateSettings=function(ab){Q=true;var aj=null;var W=null;var am=null;var an=null;var ad=null;var av=null;var au=null;var ak=null;var ap=null;var X=null;var T=null;var Z=null;var aq=null;var ae=null;var ac=null;var ag=null;var ao=null;var ar=null;var V=null;var al=null;var U=null;var ah=null;
var af=null;var ai=null;var aa=null;var Y=null;var at=null;if(ab!=null&&ab.info!=null){au=ab.info.platform;ak=ab.info.id;if(ab.info.time!=null){aj=ab.info.time.offset;W=ab.info.time.zoneOffset}if(ab.info.screen!=null){am=ab.info.screen.width;an=ab.info.screen.height;ad=ab.info.screen.factor;av=ab.info.screen.zoomFactor}if(ab.info.framework!=null&&ab.info.framework.settings!=null){ap=ab.info.framework.settings.animate;X=ab.info.framework.settings.transform;T=ab.info.framework.settings.input;Z=ab.info.framework.settings.remote;aq=ab.info.framework.settings.layout;ae=ab.info.framework.settings.scale;ac=ab.info.framework.settings.zoom;ag=ab.info.framework.settings.center;ao=ab.info.framework.settings.background;ar=ab.info.framework.settings.leave;V=ab.info.framework.settings.exit;al=ab.info.framework.settings.back;U=ab.info.framework.settings.volume;ah=ab.info.framework.settings.busy;af=ab.info.framework.settings.speed;ai=ab.info.framework.settings.playback;aa=ab.info.framework.settings.fullscreen;
Y=ab.info.framework.settings.suspend;at=ab.info.framework.settings.secure}}k.TIME_OFFSET=a.strToNum(aj,k.TIME_OFFSET);k.TIME_ZONE_OFFSET=a.strToNum(W,k.TIME_ZONE_OFFSET);k.SCREEN_WIDTH=a.strToNum(am,k.SCREEN_WIDTH);k.SCREEN_HEIGHT=a.strToNum(an,k.SCREEN_HEIGHT);k.SCREEN_FACTOR=a.strToNum(ad,k.SCREEN_FACTOR);k.ZOOM_FACTOR=a.strToNum(av,k.ZOOM_FACTOR);k.PLATFORM=a.strFullCheck(au,k.PLATFORM);k.ID=a.strFullCheck(ak,k.ID);k.ANIMATE=a.strToNum(ap,k.ANIMATE);k.TRANSFORM=a.strToNum(X,k.TRANSFORM);k.INPUT=a.strToNum(T,k.INPUT);k.REMOTE=a.strToNum(Z,k.REMOTE);k.LAYOUT=a.strFullCheck(aq,k.LAYOUT);k.SCALE=a.strFullCheck(ae,k.SCALE);k.ZOOM=a.strFullCheck(ac,k.ZOOM);k.CENTER=a.strToNum(ag,k.CENTER);k.BACKGROUND=a.strToNum(ao,k.BACKGROUND);k.LEAVE=a.strToNum(ar,k.LEAVE);k.EXIT=a.strToNum(V,k.EXIT);k.BACK=a.strToNum(al,k.BACK);k.VOLUME=a.strToNum(U,k.VOLUME);k.BUSY=a.strToNum(ah,k.BUSY);k.SPEED=a.strToNum(af,k.SPEED);k.PLAYBACK=a.strToNum(ai,k.PLAYBACK);k.FULLSCREEN=a.strToNum(aa,k.FULLSCREEN);k.SUSPEND=a.strToNum(Y,k.SUSPEND);
k.SECURE=a.strToNum(at,k.SECURE);P(ab)};this.onValidatedSettings=function(T){if(typeof T=="function"){if(Q){T()}else{J(T)}}};this.handleSettingsEvent=function(U){if(U!=null&&a.isFullStr(U.event)&&U.event.indexOf("settings:")==0){var T=U.event.substr(9);if(T=="animate"){k.ANIMATE=a.strToNum(U.value,k.ANIMATE)}else{if(T=="transform"){k.TRANSFORM=a.strToNum(U.value,k.TRANSFORM)}else{if(T=="input"){k.INPUT=a.strToNum(U.value,k.INPUT)}else{if(T=="remote"){k.REMOTE=a.strToNum(U.value,k.REMOTE)}else{if(T=="layout"){k.LAYOUT=a.strToNum(U.value,k.LAYOUT)}else{if(T=="scale"){k.SCALE=a.strFullCheck(U.value,k.SCALE)}else{if(T=="zoom"){k.ZOOM=a.strFullCheck(U.value,k.ZOOM)}}}}}}}}};this.getFrameworkInfo=function(T){return a.strFullCheck(K(T),"-")+" "+a.strFullCheck(M(T),"-")};this.getApplicationInfo=function(T){return a.strFullCheck(I(T),"-")+" "+a.strFullCheck(O(T),"-")};this.getContentInfo=function(T){return a.strFullCheck(L(T),"-")+" "+a.strFullCheck(R(T),"-")};this.checkFramework=function(V,U,T){return a.checkVersion(M(V),U)&&N(K(V),T)
};this.checkApplication=function(V,U,T){return a.checkVersion(O(V),U)&&N(I(V),T)};this.checkContent=function(V,U,T){return a.checkVersion(R(V),U)&&N(L(V),T)};this.isSameContentState=function(U,T){return U!=null&&T!=null&&U.start===T.start&&U.restored===T.restored&&U.menuId===T.menuId&&U.menuFlag===T.menuFlag&&U.menuFocus===T.menuFocus&&U.menuIndex===T.menuIndex&&U.menuSize===T.menuSize&&U.contentId===T.contentId&&U.contentFlag===T.contentFlag&&U.contentFocus===T.contentFocus&&U.contentIndex===T.contentIndex&&U.contentSize===T.contentSize&&U.contentVisible===T.contentVisible&&U.panelId===T.panelId&&U.panelFlag===T.panelFlag&&U.panelFocus===T.panelFocus&&U.panelIndex===T.panelIndex&&U.panelSize===T.panelSize&&U.panelVisible===T.panelVisible&&U.videoVisible===T.videoVisible&&U.videoActive===T.videoActive&&U.playerVisible===T.playerVisible&&U.slideshowVisible===T.slideshowVisible&&U.volumeVisible===T.volumeVisible&&U.logVisible===T.logVisible};this.createChangedContentState=function(U,T){return T!=null?{init:T.init,initChanged:U==null||U.init!==T.init,start:T.start,startChanged:U==null||U.start!==T.start,restored:T.restored,restoredChanged:U==null||U.restored!==T.restored,menuId:T.menuId,menuIdChanged:U==null||U.menuId!==T.menuId,menuFlag:T.menuFlag,menuFlagChanged:U==null||U.menuFlag!==T.menuFlag,menuFocus:T.menuFocus,menuFocusChanged:U==null||U.menuFocus!==T.menuFocus,menuIndex:T.menuIndex,menuIndexChanged:U==null||U.menuIndex!==T.menuIndex,menuSize:T.menuSize,menuSizeChanged:U==null||U.menuSize!==T.menuSize,contentId:T.contentId,contentIdChanged:U==null||U.contentId!==T.contentId,contentFlag:T.contentFlag,contentFlagChanged:U==null||U.contentFlag!==T.contentFlag,contentFocus:T.contentFocus,contentFocusChanged:U==null||U.contentFocus!==T.contentFocus,contentIndex:T.contentIndex,contentIndexChanged:U==null||U.contentIndex!==T.contentIndex,contentSize:T.contentSize,contentSizeChanged:U==null||U.contentSize!==T.contentSize,contentVisible:T.contentVisible,contentVisibleChanged:U==null||U.contentVisible!==T.contentVisible,panelId:T.panelId,panelIdChanged:U==null||U.panelId!==T.panelId,panelFlag:T.panelFlag,panelFlagChanged:U==null||U.panelFlag!==T.panelFlag,panelFocus:T.panelFocus,panelFocusChanged:U==null||U.panelFocus!==T.panelFocus,panelIndex:T.panelIndex,panelIndexChanged:U==null||U.panelIndex!==T.panelIndex,panelSize:T.panelSize,panelSizeChanged:U==null||U.panelSize!==T.panelSize,panelVisible:T.panelVisible,panelVisibleChanged:U==null||U.panelVisible!==T.panelVisible,videoVisible:T.videoVisible,videoVisibleChanged:U==null||U.videoVisible!==T.videoVisible,videoActive:T.videoActive,videoActiveChanged:U==null||U.videoActive!==T.videoActive,playerVisible:T.playerVisible,playerVisibleChanged:U==null||U.playerVisible!==T.playerVisible,slideshowVisible:T.slideshowVisible,slideshowVisibleChanged:U==null||U.slideshowVisible!==T.slideshowVisible,volumeVisible:T.volumeVisible,volumeVisibleChanged:U==null||U.volumeVisible!==T.volumeVisible,logVisible:T.logVisible,logVisibleChanged:U==null||U.logVisible!==T.logVisible}:U
}};var E=new function(){var L="videoPlugin";var aB="vrq";var ah=100;var N=30000;var ac=new o("VnckdhvbF'sOhm)XlK1t]ETl]+K8q-tDgevE3N;7Zm[u#V1/W)U-_@_@,A4(B#zGF~8JHfJr?=D2*n9WC7&0i/a+2S,Qky5&..Nx!p(wUoLRIdos?HBLZ;T'CRb=eqGi3yc5$*Q%~P6MYjrj6P40aISO$!AXYwMzu%[x9gpf");var R=null;var Z=false;var az=null;var aN=false;var P=false;var am=false;var aV=false;var a3=null;var a5=new i();var Y=new n(1000);var aD=new n(1000);var aM=false;var a0={state:0,position:0,duration:0,speed:1,ended:false,volume:100,muted:false,width:k.SCREEN_WIDTH,height:k.SCREEN_HEIGHT};var ad=function(a6){R=new o(a6)};var ao=function(a6){if(aN){if(a6=="local"){return R!=null?R.createSteam():null}return ac.createSteam()}return null};var K=function(a6,a7){if(aN){if(a7=="local"){return R!=null?R.resolveToken(a6):null}return ac.resolveToken(a6)}return null};var aE=function(a6,a7){if(aN){if(a7=="local"){return R!=null?R.transformString(a6):null}else{if(a7=="global"){return ac.transformString(a6)}else{if(a7=="shared"){return m.transformString(R!=null?R.transformString(a6):a6)
