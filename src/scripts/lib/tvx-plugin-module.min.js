...
};this.getApplicationInfo=function(S){return B.strFullCheck(H(S),"-")+" "+B.strFullCheck(N(S),"-")};this.getContentInfo=function(S){return B.strFullCheck(K(S),"-")+" "+B.strFullCheck(Q(S),"-")};this.checkFramework=function(U,T,S){return B.checkVersion(L(U),T)&&M(J(U),S)};this.checkApplication=function(U,T,S){return B.checkVersion(N(U),T)&&M(H(U),S)};this.checkContent=function(U,T,S){return B.checkVersion(Q(U),T)&&M(K(U),S)};this.isSameContentState=function(T,S){return T!=null&&S!=null&&T.start===S.start&&T.restored===S.restored&&T.menuId===S.menuId&&T.menuFlag===S.menuFlag&&T.menuFocus===S.menuFocus&&T.menuIndex===S.menuIndex&&T.menuSize===S.menuSize&&T.contentId===S.contentId&&T.contentFlag===S.contentFlag&&T.contentFocus===S.contentFocus&&T.contentIndex===S.contentIndex&&T.contentSize===S.contentSize&&T.sceneVisible===S.sceneVisible&&T.sceneActive===S.sceneActive&&T.videoVisible===S.videoVisible&&T.videoActive===S.videoActive&&T.slideshowActive===S.slideshowActive&&T.overlayActive===S.overlayActive
};this.createChangedContentState=function(T,S){return S!=null?{init:S.init,initChanged:T==null||T.init!==S.init,start:S.start,startChanged:T==null||T.start!==S.start,restored:S.restored,restoredChanged:T==null||T.restored!==S.restored,menuId:S.menuId,menuIdChanged:T==null||T.menuId!==S.menuId,menuFlag:S.menuFlag,menuFlagChanged:T==null||T.menuFlag!==S.menuFlag,menuFocus:S.menuFocus,menuFocusChanged:T==null||T.menuFocus!==S.menuFocus,menuIndex:S.menuIndex,menuIndexChanged:T==null||T.menuIndex!==S.menuIndex,menuSize:S.menuSize,menuSizeChanged:T==null||T.menuSize!==S.menuSize,contentId:S.contentId,contentIdChanged:T==null||T.contentId!==S.contentId,contentFlag:S.contentFlag,contentFlagChanged:T==null||T.contentFlag!==S.contentFlag,contentFocus:S.contentFocus,contentFocusChanged:T==null||T.contentFocus!==S.contentFocus,contentIndex:S.contentIndex,contentIndexChanged:T==null||T.contentIndex!==S.contentIndex,contentSize:S.contentSize,contentSizeChanged:T==null||T.contentSize!==S.contentSize,sceneVisible:S.sceneVisible,sceneVisibleChanged:T==null||T.sceneVisible!==S.sceneVisible,sceneActive:S.sceneActive,sceneActiveChanged:T==null||T.sceneActive!==S.sceneActive,videoVisible:S.videoVisible,videoVisibleChanged:T==null||T.videoVisible!==S.videoVisible,videoActive:S.videoActive,videoActiveChanged:T==null||T.videoActive!==S.videoActive,slideshowActive:S.slideshowActive,slideshowActiveChanged:T==null||T.slideshowActive!==S.slideshowActive,overlayActive:S.overlayActive,overlayActiveChanged:T==null||T.overlayActive!==S.overlayActive}:T
}};var j=new function(){var K="videoPlugin";var az="vrq";var af=100;var M=30000;var aa=new z("VnckdhvbF'sOhm)XlK1t]ETl]+K8q-tDgevE3N;7Zm[u#V1/W)U-_@_@,A4(B#zGF~8JHfJr?=D2*n9WC7&0i/a+2S,Qky5&..Nx!p(wUoLRIdos?HBLZ;T'CRb=eqGi3yc5$*Q%~P6MYjrj6P40aISO$!AXYwMzu%[x9gpf");var Q=null;var X=false;var ax=null;var aL=false;var O=false;var ak=false;var aT=false;var a1=null;var a3=new a();var W=new u(1000);var aB=new u(1000);var aK=false;var aY={state:0,position:0,duration:0,speed:1,ended:false,volume:100,muted:false,width:k.SCREEN_WIDTH,height:k.SCREEN_HEIGHT};var ab=function(a4){Q=new z(a4)};var am=function(a4){if(aL){if(a4=="local"){return Q!=null?Q.createSteam():null}return aa.createSteam()}return null};var J=function(a4,a5){if(aL){if(a5=="local"){return Q!=null?Q.resolveToken(a4):null}return aa.resolveToken(a4)}return null};var aC=function(a4,a5){if(aL){if(a5=="local"){return Q!=null?Q.transformString(a4):null}else{if(a5=="global"){return aa.transformString(a4)}else{if(a5=="shared"){return t.transformString(Q!=null?Q.transformString(a4):a4)
}}}return aa.transformString(Q!=null?Q.transformString(a4):a4)}return null};var Z=function(a4,a5){if(aL){if(a5=="local"){return Q!=null?Q.normalizeString(a4):null}else{if(a5=="global"){return aa.normalizeString(a4)}else{if(a5=="shared"){return Q!=null?Q.normalizeString(t.normalizeString(a4)):t.normalizeString(a4)}}}return Q!=null?Q.normalizeString(aa.normalizeString(a4)):aa.normalizeString(a4)}return null};var aU=function(a4){if(B.isNum(a4)){a4=B.strToNum(a4,0);if(isFinite(a4)){return a4}}return 0};var L=function(){if(aY.position==0||aY.duration==0){try{var a4=false;if(aY.position==0){aY.position=aU(a1.getPosition());a4=aY.position>0}if(aY.duration==0){aY.duration=aU(a1.getDuration());a4=aY.duration>0}if(aY.position>0&&aY.duration>0){aR()}if(a4){R()}}catch(a5){ag("Start failed",a5);aR()}}else{aR()}};var aR=function(){X=true;Y()};var a0=function(){Y();if(aL&&!X&&a1!=null&&typeof a1.getPosition=="function"&&typeof a1.getDuration=="function"){ax=setInterval(L,af)}};var Y=function(){if(ax!=null){clearInterval(ax);
ax=null}};var aV=0;var aO={};var aq=function(a6){aV++;var a4=az+aV+"_"+q.getTimestamp();var a5={timeout:new u(M),callback:a6};aO[a4]=a5;a5.timeout.start(function(){at(a4,{error:"Request timed out"})});return a4};var at=function(a4,a6){if(a4!=null){var a5=aO[a4];if(a5!=null){a5.timeout.stop();delete aO[a4];U(a5.callback,a6)}}};var U=function(a6,a4){if(typeof a6=="function"){try{a6(a4)}catch(a5){ag("Callback error",a5)}}};var aS=new h();var T=new u(500);var au=null;var aE=null;var ac=function(a4){if(a4!=null){if(C.isSameContentState(au,a4)){if(!C.isSameContentState(aE,a4)){if(aE==null){a4.init=true}aE=C.createChangedContentState(aE,a4);aS.notifyObservers(aE)}}else{au=a4}}ad()};var aJ=function(){if(aL){an("info:content",function(a4){ac(a4.info!=null&&a4.info.content!=null?a4.info.content.state:null)})}else{ad()}};var ad=function(a4){if(aS.hasObservers()){if(B.isFullStr(a4)&&aE!=null){aS.notifyObserver(a4,aE)}T.start(aJ)}else{au=null;aE=null;T.stop()}};var R=function(){V(aY)};var aD=function(){a3.addHook(K,ay)
};var aW=function(){if(aY.state==l.STOPPED){a3.stop()}else{a3.start()}};var S=function(a4,a5){if(B.isFullStr(a4)){V({action:a4,data:a5!=null?a5:null})}};var av=function(a5,a4){if(B.isFullStr(a5)){if(a4!==false){S("logger:debug:"+a5)}}};var aA=function(a5,a4,a6){if(B.isFullStr(a5)){if(a4!==false){S("logger:success:"+a5,{show:a6!==false})}else{if(a6!==false){S("success:"+a5)}}}};var a2=function(a5,a4,a6){if(B.isFullStr(a5)){if(a4!==false){S("logger:info:"+a5,{show:a6!==false})}else{if(a6!==false){S("info:"+a5)}}}};var ah=function(a5,a4,a6){if(B.isFullStr(a5)){if(a4!==false){S("logger:warn:"+a5,{show:a6!==false})}else{if(a6!==false){S("warn:"+a5)}}}};var ar=function(a5,a4,a6){if(B.isFullStr(a5)){if(a4!==false){S("logger:error:"+a5,{show:a6!==false})}else{if(a6!==false){S("error:"+a5)}}}};var N=function(a4,a5){if(B.isFullStr(a4)&&a5!=null){if(typeof a5=="object"){S(a4+":data",a5)}else{S(a4+":"+a5)}}};var aN=function(a4){N("menu",a4)};var ap=function(a4){N("content",a4)};var ao=function(a4){N("panel",a4)
};var an=function(a4,a6,a5){if(B.isFullStr(a4)){if(a5==null){a5={}}a5.requestId=aq(a6);a5.dataId=a4;S("player:commit:"+a4,a5)}else{U(a6,{error:"Data ID is invalid: '"+a4+"'"})}};var ag=function(a4,a5){if(a4!=null&&a5!=null){if(a5.name!=null&&a5.message!=null){ar("Plugin: "+a4+": "+a5.name+": "+a5.message)}else{ar("Plugin: "+a4+": "+a5)}}};var H=function(a4){if(aY.state!=l.PLAYING||a4===true){aY.state=l.PLAYING;if(aL&&a1!=null&&typeof a1.play=="function"){try{a1.play()}catch(a5){ag("Play failed",a5)}}}};var aM=function(a4){if(aY.state!=l.PAUSED||a4===true){aY.state=l.PAUSED;if(aL&&a1!=null&&typeof a1.pause=="function"){try{a1.pause()}catch(a5){ag("Pause failed",a5)}}}};var aZ=function(a4){if(aY.state!=l.STOPPED||a4===true){aY.state=l.STOPPED;if(aL&&a1!=null&&typeof a1.stop=="function"){try{a1.stop()}catch(a5){ag("Stop failed",a5)}}}};var aP=function(a4,a5){if(a4==l.PLAYING){H(a5)}else{if(a4==l.PAUSED){aM(a5)}else{if(a4==l.STOPPED){aZ(a5)}}}};var ay=function(){if(aL&&a1!=null&&!W.isBusy()&&typeof a1.getUpdateData=="function"){try{var a5=a1.getUpdateData();
if(a5!=null){var a6=false;if(B.isNum(a5.state)){a6=true;aY.state=B.strToNum(a5.state,aY.state)}if(B.isNum(a5.position)){a6=true;aY.position=B.strToNum(a5.position,aY.position);if(!isFinite(aY.position)){aY.position=0}}if(B.isNum(a5.duration)){a6=true;aY.duration=B.strToNum(a5.duration,aY.duration);if(!isFinite(aY.duration)){aY.duration=0}}if(B.isNum(a5.speed)){a6=true;aY.speed=B.strToNum(a5.speed,aY.speed)}if(B.isBool(a5.ended)){a6=true;aY.ended=B.strToBool(a5.ended,aY.ended)}if(B.isNum(a5.volume)){a6=true;aY.volume=B.strToNum(a5.volume,aY.volume)}if(B.isBool(a5.muted)){a6=true;aY.muted=B.strToBool(a5.muted,aY.muted)}if(a6){R();aW()}}}catch(a4){ag("Update failed",a4)}}};var aG=function(a6,a4){aT=false;if(aY.position!=a6||a6==0||a4===true){aY.position=a6;if(aL&&a1!=null&&typeof a1.setPosition=="function"){try{a1.setPosition(a6);if(!aT){W.start()}}catch(a5){ag("Set position failed",a5)}}}};var aH=function(a4,a6){if(aY.volume!=a4||a6===true){aY.volume=a4;if(aL&&a1!=null&&typeof a1.setVolume=="function"){try{a1.setVolume(a4)
}catch(a5){ag("Set volume failed",a5)}}}};var P=function(a4,a5){if(aY.muted!=a4||a5===true){aY.muted=a4;if(aL&&a1!=null&&typeof a1.setMuted=="function"){try{a1.setMuted(a4)}catch(a6){ag("Set muted failed",a6)}}}};var aX=function(a4,a5){if(aY.speed!=a4||a5===true){aY.speed=a4;if(aL&&a1!=null&&typeof a1.setSpeed=="function"){try{a1.setSpeed(a4)}catch(a6){ag("Set speed failed",a6)}}}};var al=function(a5,a4,a6){if(aY.width!=a5||aY.height!=a4||a6===true){aY.width=a5;aY.height=a4;if(aL&&a1!=null&&typeof a1.setSize=="function"){try{a1.setSize(a5,a4)}catch(a7){ag("Set size failed",a7)}}}};var aI=function(a4,a5){S("response:"+a4,a5)};var aj=function(a4,a5){at(a4,a5)};var I=function(a5,a4,a7){if(typeof a1.handleRequest=="function"){try{a1.handleRequest(a4,a7,function(a8){aI(a5,a8)})}catch(a6){ag("Handle request failed",a6);aI(a5)}}else{aI(a5)}};var aw=function(a8){if(aL&&a8!=null&&a1!=null){if(B.isFullStr(a8.requestId)&&B.isFullStr(a8.dataId)){I(a8.requestId,a8.dataId,a8.data)}else{if(a8.data!=null&&B.isFullStr(a8.data.requestId)&&B.isFullStr(a8.data.dataId)){var a5={};
var a7=a8.data.dataId;var a4=a7.indexOf(":");if(a4>0){a7=a7.substr(0,a4)}a5[a7]=a8[a7]!=null?a8[a7]:null;a5.error=B.strFullCheck(a8.error,null);aj(a8.data.requestId,a5)}else{if(typeof a1.handleData=="function"){try{a1.handleData(a8)}catch(a6){ag("Handle data failed",a6)}}}}}};var ae=function(a4){if(!ak||a4===true){ak=true;if(a1!=null&&typeof a1.init=="function"){try{a1.init()}catch(a5){ag("Call init failed",a5)}}}};var aQ=function(a4){if(!aL||a4===true){aL=true;if(a1!=null&&typeof a1.ready=="function"){try{a1.ready()}catch(a5){ag("Call ready failed",a5)}}}};var aF=function(){aL=false;window.addEventListener("message",function(a4){if(t.checkOrigin(a4.origin)){ai(a4.data)}},false);S("plugin:init")};var ai=function(a4){if(ak&&a4!=null&&a4.type===K){if(a4.init===1&&aL){return}if(B.isNum(a4.state)){aP(B.strToNum(a4.state,aY.state))}if(B.isNum(a4.position)){aG(B.strToNum(a4.position,aY.position))}if(B.isNum(a4.speed)){aX(B.strToNum(a4.speed,aY.speed))}if(B.isNum(a4.volume)){P(false);aH(B.strToNum(a4.volume,aY.volume))
}if(B.isBool(a4.muted)){P(B.strToBool(a4.muted,aY.muted))}if(B.isNum(a4.width)&&B.isNum(a4.height)){al(B.strToNum(a4.width,aY.width),B.strToNum(a4.height,aY.height))}if(a4.init===1){aQ()}else{if(a4.data!=null){aw(a4.data)}}}};var V=function(a5){if(window.parent!=null&&a5!=null){a5.type=K;a5.sender="plugin";a5.target="app";try{window.parent.postMessage(a5,"*")}catch(a4){if(window.console!=null){console.error("Post message failed",a4)}}}};this.setupPlayer=function(a4){a1=a4;if(ak){ae(true)}if(aL){aQ(true)}};this.setSeekDelay=function(a4){W.delay=B.strToNum(a4,W.delay)};this.getSeekDelay=function(){return W.delay};this.setLoadingDelay=function(a4){aB.delay=B.strToNum(a4,aB.delay)};this.getLoadingDelay=function(){return aB.delay};this.setState=function(a4,a5){if(aL){aY.state=B.strToNum(a4,aY.state);if(a5===true){R()}aW()}};this.getState=function(){return aY.state};this.applyState=function(){if(aL){aP(aY.state,true)}};this.setPosition=function(a5,a4){if(aL){aT=true;aY.position=B.strToNum(a5,aY.position);
if(!isFinite(aY.position)){aY.position=0}W.stop();if(a4===true){R();aW()}}};this.getPosition=function(){return aY.position};this.applyPosition=function(){if(aL){aG(aY.position,true)}};this.setDuration=function(a4,a5){if(aL){aY.duration=B.strToNum(a4,aY.duration);if(!isFinite(aY.duration)){aY.duration=0}if(a5===true){R();aW()}}};this.getDuration=function(){return aY.duration};this.setSpeed=function(a4,a5){if(aL){aY.speed=B.strToNum(a4,aY.speed);if(a5===true){R();aW()}}};this.getSpeed=function(){return aY.speed};this.applySpeed=function(){if(aL){aX(aY.speed,true)}};this.setEnded=function(a4,a5){if(aL){aY.ended=B.strToBool(a4,aY.ended);if(a5===true){R();aW()}}};this.hasEnded=function(){return aY.ended};this.setVolume=function(a5,a4){if(aL){aY.volume=B.strToNum(a5,aY.volume);if(a4===true){R();aW()}}};this.getVolume=function(){return aY.volume};this.setMuted=function(a4,a5){if(aL){aY.muted=B.strToBool(a4,aY.muted);if(a5===true){R();aW()}}};this.isMuted=function(){return aY.muted};this.applyVolume=function(){if(aL){aH(aY.volume,true);
P(aY.muted,true)}};this.getWidth=function(){return aY.width};this.getHeight=function(){return aY.height};this.applySize=function(){if(aL){al(aY.width,aY.height,true)}};this.executeAction=function(a4,a5){if(aL){S(a4,a5)}};this.debug=function(a5,a4){if(aL){av(a5,a4)}};this.success=function(a5,a4,a6){if(aL){aA(a5,a4,a6)}};this.info=function(a5,a4,a6){if(aL){a2(a5,a4,a6)}};this.warn=function(a5,a4,a6){if(aL){ah(a5,a4,a6)}};this.error=function(a5,a4,a6){if(aL){ar(a5,a4,a6)}};this.showMenu=function(a4){if(aL){aN(a4)}};this.showContent=function(a4){if(aL){ap(a4)}};this.showPanel=function(a4){if(aL){ao(a4)}};this.showPlayer=function(){if(aL){S("player:show")}};this.showAction=function(){if(aL){S("player:action")}};this.hidePlayer=function(){if(aL){S("player:hide")}};this.setupContentLabel=function(a4){if(aL){S("player:label:content:"+B.strFullCheck(a4,"default"))}};this.setupExtensionLabel=function(a4){if(aL){S("player:label:extension:"+B.strFullCheck(a4,"default"))}};this.setupPositionLabel=function(a4){if(aL){S("player:label:position:"+B.strFullCheck(a4,"default"))
}};this.setupDurationLabel=function(a4){if(aL){S("player:label:duration:"+B.strFullCheck(a4,"default"))}};this.enableButton=function(a4){if(aL&&B.isId(a4)){S("player:button:"+a4+":enable")}};this.disableButton=function(a4){if(aL&&B.isId(a4)){S("player:button:"+a4+":disable")}};this.focusButton=function(a4){if(aL&&B.isId(a4)){S("player:button:"+a4+":focus")}};this.setupProgressColor=function(a4){if(aL){S("player:progress:color:"+B.strFullCheck(a4,"default"))}};this.setupProgressType=function(a4){if(aL){S("player:progress:type:"+B.strFullCheck(a4,"default"))}};this.enableProgressMarker=function(){if(aL){S("player:progress:marker:enable")}};this.disableProgressMarker=function(){if(aL){S("player:progress:marker:disable")}};this.invalidateProgressMarker=function(){if(aL){S("player:progress:marker:invalidate")}};this.setupBackground=function(a4){if(aL){S("player:background:"+B.strFullCheck(a4,"default"))}};this.setupTrigger=function(a4,a5,a6){if(aL&&B.isFullStr(a4)&&B.isFullStr(a5)){if(a6===true){S("trigger:"+a4+":shot:"+a5)
}else{S("trigger:"+a4+":"+a5)}}};this.clearTrigger=function(a4){if(aL&&B.isFullStr(a4)){S("trigger:"+a4+":none")}};this.refreshPlayer=function(){if(aL){S("player:refresh")}};this.resetPlayer=function(){if(aL){S("player:reset")}};this.cancelResume=function(){if(aL){S("resume:cancel")}};this.requestData=function(a4,a6,a5){if(aL){an(a4,a6,a5)}else{U(a6,{error:"Plugin not ready"})}};this.requestInteractionResponse=function(a4,a6,a5){if(B.isFullStr(a4)){this.requestData("response:request:interaction:"+a4,a6,a5!=null?{requestData:a5}:null)}else{U(a6,{error:"Data ID is invalid: '"+a4+"'"})}};this.validateSettings=function(a4){C.invalidateSettings();this.requestData("info",function(a5){C.validateSettings(a5);U(a4,a5)})};this.onValidatedSettings=function(a4){if(!C.areSettingsValidated()&&!aK){aK=true;this.validateSettings(function(){aK=false})}C.onValidatedSettings(a4)};this.triggerEvent=function(a4,a5){if(aL&&B.isFullStr(a4)){S("event:"+a4,a5)}};this.setupSteam=function(a4){ab(a4)};this.createSteam=function(a4){return am(a4)
};this.resolveToken=function(a4,a5){return J(a4,a5)};this.transformString=function(a4,a5){return aC(a4,a5)};this.normalizeString=function(a4,a5){return Z(a4,a5)};this.transformStringAsync=function(a6,a7,a5){var a4=aC(a6,a7);if(B.isFullStr(a4)){this.requestData("string:transform:"+a4,function(a8){U(a5,{string:B.strFullCheck(a8.string,null)})})}else{U(a5,{string:null})}};this.normalizeStringAsync=function(a5,a6,a4){if(B.isFullStr(a5)){this.requestData("string:normalize:"+a5,function(a7){U(a4,{string:Z(a7.string,a6)})})}else{U(a4,{string:null})}};this.createHashKey=function(a4,a5){return t.createHashKey(a4,a5)};this.hasContentObservers=function(){return aS.hasObservers()};this.addContentObserver=function(a4,a5){aS.addObserver(a4,a5);ad(a4)};this.removeContentObserver=function(a4){aS.removeObserver(a4);ad()};this.clearContentObservers=function(){aS.clear();ad()};this.init=function(){if(!ak){aF();aD();ae()}};this.commit=function(){if(aL){R();aW()}};this.isInitialized=function(){return ak};this.isReady=function(){return aL
};this.startPlayback=function(a4){if(aL){aP(l.PLAYING,true);R();aW();if(a4===true){a0()}}};this.stopPlayback=function(){if(aL){this.setEnded(true);R();Y()}};this.cancelPlayback=function(){if(aL){S("player:eject")}};this.startLoading=function(){if(aL){aB.start(function(){O=true;S("player:busy:start:loading")})}};this.stopLoading=function(){if(aL){aB.stop();if(O){O=false;S("player:busy:stop:loading")}}}};var c=new function(){var K="interactionPlugin";var ao="irq";var ae=10;var aH=30000;var W=new z("j3RZ!=Y$M5TZ#JPem'P1i(Tf?X3WcGlyCqNeXRbp02HL]I~r!IfO(pvxQ7At%9yq.5=)wm@0o?Js[sUbUH416uhd;_S/Qr,w7vW]jBgND;GazhCL+D%z~8ni+n-B_E-KK42tl[OAV@*E.Ya6$V,&kF)o&Mg98#'ucx/dk*SF");var P=null;var O=false;var aq=new u(1000);var az=false;var ag=false;var aa=null;var ay=false;var aD=null;var X=function(aL){P=new z(aL)};var ah=function(aL){if(az){if(aL=="local"){return P!=null?P.createSteam():null}return W.createSteam()}return null};var I=function(aL,aM){if(az){if(aM=="local"){return P!=null?P.resolveToken(aL):null
}return W.resolveToken(aL)}return null};var ar=function(aL,aM){if(az){if(aM=="local"){return P!=null?P.transformString(aL):null}else{if(aM=="global"){return W.transformString(aL)}else{if(aM=="shared"){return t.transformString(P!=null?P.transformString(aL):aL)}}}return W.transformString(P!=null?P.transformString(aL):aL)}return null};var V=function(aL,aM){if(az){if(aM=="local"){return P!=null?P.normalizeString(aL):null}else{if(aM=="global"){return W.normalizeString(aL)}else{if(aM=="shared"){return P!=null?P.normalizeString(t.normalizeString(aL)):t.normalizeString(aL)}}}return P!=null?P.normalizeString(W.normalizeString(aL)):W.normalizeString(aL)}return null};var aI=0;var aC={};var aj=function(aN){aI++;var aL=ao+aI+"_"+q.getTimestamp();var aM={timeout:new u(aH),callback:aN};aC[aL]=aM;aM.timeout.start(function(){al(aL,{error:"Request timed out"})});return aL};var al=function(aL,aN){if(aL!=null){var aM=aC[aL];if(aM!=null){aM.timeout.stop();delete aC[aL];S(aM.callback,aN)}}};var S=function(aN,aL){if(typeof aN=="function"){try{aN(aL)
}catch(aM){ac("Callback error",aM)}}};var aG=new h();var ab=new u(500);var am=null;var au=null;var Y=function(aL){if(aL!=null){if(C.isSameContentState(am,aL)){if(!C.isSameContentState(au,aL)){if(au==null){aL.init=true}au=C.createChangedContentState(au,aL);aG.notifyObservers(au)}}else{am=aL}}Z()};var ax=function(){if(az){ai("info:content",function(aL){Y(aL.info!=null&&aL.info.content!=null?aL.info.content.state:null)})}else{Z()}};var Z=function(aL){if(aG.hasObservers()){if(B.isFullStr(aL)&&au!=null){aG.notifyObserver(aL,au)}ab.start(ax)}else{am=null;au=null;ab.stop()}};var Q=function(aL,aM){if(B.isFullStr(aL)){T({action:aL,data:aM!=null?aM:null})}};var at=function(aM,aL){if(B.isFullStr(aM)){if(aL!==false){Q("logger:debug:"+aM)}}};var ap=function(aM,aL,aN){if(B.isFullStr(aM)){if(aL!==false){Q("logger:success:"+aM,{show:aN!==false})}else{if(aN!==false){Q("success:"+aM)}}}};var aK=function(aM,aL,aN){if(B.isFullStr(aM)){if(aL!==false){Q("logger:info:"+aM,{show:aN!==false})}else{if(aN!==false){Q("info:"+aM)
}}}};var ad=function(aM,aL,aN){if(B.isFullStr(aM)){if(aL!==false){Q("logger:warn:"+aM,{show:aN!==false})}else{if(aN!==false){Q("warn:"+aM)}}}};var ak=function(aM,aL,aN){if(B.isFullStr(aM)){if(aL!==false){Q("logger:error:"+aM,{show:aN!==false})}else{if(aN!==false){Q("error:"+aM)}}}};var M=function(aL,aM){if(B.isFullStr(aL)&&aM!=null){if(typeof aM=="object"){Q(aL+":data",aM)}else{Q(aL+":"+aM)}}};var aB=function(aL){M("menu",aL)};var U=function(aL){M("content",aL)};var R=function(aL){M("panel",aL)};var ai=function(aL,aN,aM){if(B.isFullStr(aL)){if(aM==null){aM={}}aM.requestId=aj(aN);aM.dataId=aL;Q("interaction:commit:"+aL,aM)}else{S(aN,{error:"Data ID is invalid: '"+aL+"'"})}};var ac=function(aL,aM){if(aL!=null&&aM!=null){if(aM.name!=null&&aM.message!=null){ak("Interaction: "+aL+": "+aM.name+": "+aM.message)}else{ak("Interaction: "+aL+": "+aM)}}};var aw=function(aL,aM){Q("response:"+aL,aM)};var af=function(aL,aM){al(aL,aM)};var H=function(aM,aL,aO){if(typeof aa.handleRequest=="function"){try{aa.handleRequest(aL,aO,function(aP){aw(aM,aP)
})}catch(aN){ac("Handle request failed",aN);aw(aM)}}else{aw(aM)}};var aJ=function(aM){if(az&&aM!=null&&aa!=null){if(typeof aa.handleEvent=="function"){try{aa.handleEvent(aM)}catch(aL){ac("Handle event failed",aL)}}}};var an=function(aP){if(az&&aP!=null&&aa!=null){if(B.isFullStr(aP.requestId)&&B.isFullStr(aP.dataId)){H(aP.requestId,aP.dataId,aP.data)}else{if(aP.data!=null&&B.isFullStr(aP.data.requestId)&&B.isFullStr(aP.data.dataId)){var aM={};var aO=aP.data.dataId;var aL=aO.indexOf(":");if(aL>0){aO=aO.substr(0,aL)}aM[aO]=aP[aO]!=null?aP[aO]:null;aM.error=B.strFullCheck(aP.error,null);af(aP.data.requestId,aM)}else{if(typeof aa.handleData=="function"){try{aa.handleData(aP)}catch(aN){ac("Handle data failed",aN)}}}}}};var aE=function(aL){aD=aL!=null&&aL.length>0?aL:null};var N=function(){if(aD!=null&&aD.length>0){for(var aL=0;aL<aD.length;aL++){an(aD[aL])}}aD=null};var aF=function(aL){if(az&&aL!=null){if(aD==null){aD=[]}if(aD.length>=ae){aD.shift()}aD.push(aL)}};var L=function(aL){if(!ag||aL===true){ag=true;
if(aa!=null&&typeof aa.init=="function"){try{aa.init()}catch(aM){ac("Call init failed",aM)}}}};var aA=function(aL){if(!az||aL===true){az=true;if(aa!=null&&typeof aa.ready=="function"){try{aa.ready()}catch(aM){ac("Call ready failed",aM)}}if(aa!=null){N()}}};var av=function(){az=false;window.addEventListener("message",function(aL){if(t.checkOrigin(aL.origin)){J(aL.data)}},false);Q("interaction:init")};var J=function(aL){if(ag&&aL!=null&&aL.type===K){if(aL.init===1&&az){return}if(aL.init===1){aE(aL.data);aA()}else{if(aL.data!=null){if(B.isFullStr(aL.data.event)){aJ(aL.data)}else{if(aa!=null){an(aL.data)}else{aF(aL.data)}}}}}};var T=function(aM){if(window.parent!=null&&aM!=null){aM.type=K;aM.sender="plugin";aM.target="app";try{window.parent.postMessage(aM,"*")}catch(aL){if(window.console!=null){console.error("Post message failed",aL)}}}};this.setupHandler=function(aL){aa=aL;if(ag){L(true)}if(az){aA(true)}};this.setLoadingDelay=function(aL){aq.delay=B.strToNum(aL,aq.delay)};this.getLoadingDelay=function(){return aq.delay
};this.executeAction=function(aL,aM){if(az){Q(aL,aM)}};this.debug=function(aM,aL){if(az){at(aM,aL)}};this.success=function(aM,aL,aN){if(az){ap(aM,aL,aN)}};this.info=function(aM,aL,aN){if(az){aK(aM,aL,aN)}};this.warn=function(aM,aL,aN){if(az){ad(aM,aL,aN)}};this.error=function(aM,aL,aN){if(az){ak(aM,aL,aN)}};this.showMenu=function(aL){if(az){aB(aL)}};this.showContent=function(aL){if(az){U(aL)}};this.showPanel=function(aL){if(az){R(aL)}};this.requestData=function(aL,aN,aM){if(az){ai(aL,aN,aM)}else{S(aN,{error:"Plugin not ready"})}};this.requestPlayerResponse=function(aL,aN,aM){if(B.isFullStr(aL)){this.requestData("response:request:player:"+aL,aN,aM!=null?{requestData:aM}:null)}else{S(aN,{error:"Data ID is invalid: '"+aL+"'"})}};this.validateSettings=function(aL){C.invalidateSettings();this.requestData("info",function(aM){C.validateSettings(aM);S(aL,aM)})};this.onValidatedSettings=function(aL){if(!C.areSettingsValidated()&&!ay){ay=true;this.validateSettings(function(){ay=false})}C.onValidatedSettings(aL)
};this.setupSteam=function(aL){X(aL)};this.createSteam=function(aL){return ah(aL)};this.resolveToken=function(aL,aM){return I(aL,aM)};this.transformString=function(aL,aM){return ar(aL,aM)};this.normalizeString=function(aL,aM){return V(aL,aM)};this.transformStringAsync=function(aN,aO,aM){var aL=ar(aN,aO);if(B.isFullStr(aL)){this.requestData("string:transform:"+aL,function(aP){S(aM,{string:B.strFullCheck(aP.string,null)})})}else{S(aM,{string:null})}};this.normalizeStringAsync=function(aM,aN,aL){if(B.isFullStr(aM)){this.requestData("string:normalize:"+aM,function(aO){S(aL,{string:V(aO.string,aN)})})}else{S(aL,{string:null})}};this.createHashKey=function(aL,aM){return t.createHashKey(aL,aM)};this.hasContentObservers=function(){return aG.hasObservers()};this.addContentObserver=function(aL,aM){aG.addObserver(aL,aM);Z(aL)};this.removeContentObserver=function(aL){aG.removeObserver(aL);Z()};this.clearContentObservers=function(){aG.clear();Z()};this.init=function(){if(!ag){av();L()}};this.isInitialized=function(){return ag
};this.isReady=function(){return az};this.startLoading=function(){if(az){aq.start(function(){O=true;Q("interaction:busy:start:loading")})}};this.stopLoading=function(){if(az){aq.stop();if(O){O=false;Q("interaction:busy:stop:loading")}}}};return{Settings:k,Styles:E,Tools:B,DateTools:q,DateFormatter:y,PropertyTools:d,VideoState:l,Action:x,Cookies:w,Storage:p,UrlParams:f,Options:b,Observers:h,EventObservers:m,Queue:G,Worker:e,Delay:u,Click:s,Ajax:r,LogLevel:o,Logger:n,Dictionary:F,Clock:a,Services:D,DataLoader:i,DataService:A,BlobService:v,RequestService:g,PluginTools:C,VideoPlugin:j,InteractionPlugin:c}}));