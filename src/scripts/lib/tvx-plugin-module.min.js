...
if(a.isFullStr(at)&&ab(aw)&&ab(am)){var ax=I(at,aw,am);var av=at.length;var ar=am.length;var an=0;var aq=0;var ap=false;for(var al=0;al<av;al++){ao=N(ao,O(aw,am,aj(at,al),ax,an+aq,au,ap));an=Z(an,aq,ar);if(an==0){aq=M(aq,ar)}ap=!ap}}return ao};var af=function(){return L(a.strShuffle(S),S,S)};var X=function(al,am){return ai(al,ai(am,S,S),S)};var Y=function(){if(R==null){R=ae(S)}return R};this.createSteam=function(){U=af();return U};this.resolveToken=function(al){return X(al,U)};this.transformString=function(al){return V(al,Y(),S,1)};this.normalizeString=function(al){return V(al,Y(),S,-1)}}var m=new function(){var O=16;var J=new o("k%hy.nLI1&4rN[D9YAPVCu(*&5F)'aC$=frs,wocT48qpRpXt[Gx$BQZU@B,9N;oL%j*J~hXbW)-#q#z7+0uMgHm3fEHcdK@iIG!?nP!/Y.3vFb~2eUz(sk-O/W?AtJ_VT_8]=+K;DmS6Q1iSx60]jaevER'l7y5ZlOdM2wg");var P=new o("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789");var I=new o(a.strShuffle("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"));var L=function(R,Q){return R!=null&&Q>=0&&Q<R.length?R.charAt(Q):"0"
};var M=function(Q){return Q.indexOf("-")==0?"0"+Q.substr(1):Q};var N=function(Q,T){var R=0;for(var S=Q.length;S<O;S++){Q+=L(T,R++)}return Q};var K=function(Q){return N(M(""+a.createHash(Q)),M(""+a.createHash(Q,true)))};this.checkOrigin=function(Q){if(a.isFullStr(Q)){return Q=="null"||Q=="http://msx.benzac.de"||Q=="https://msx.benzac.de"||Q=="ms-appx://52357benzac.de.mediastationx"||Q=="http://localhost"||Q.indexOf("http://localhost:")==0||Q.indexOf("file://")==0}return false};this.transformString=function(Q){return J.transformString(Q)};this.normalizeString=function(Q){return J.normalizeString(Q)};this.createHashKey=function(Q,R){if(R=="local"){return I.transformString(K(Q))}return P.transformString(K(Q))}};var s=new function(){var S=null;var Q=false;var P=function(V){if(S!=null){var T=S;S=null;if(T.length>0){for(var U=0;U<T.length;U++){T[U](V)}}}};var J=function(T){if(S==null){S=[]}S.push(T)};var N=function(U,T){if(a.isFullStr(T)){if(a.isFullStr(U)){return T==U}return false}return true
...
}};this.setupPositionLabel=function(a6){if(aN){T("player:label:position:"+a.strFullCheck(a6,"default"))}};this.setupDurationLabel=function(a6){if(aN){T("player:label:duration:"+a.strFullCheck(a6,"default"))}};this.setupSpeedLabel=function(a6){if(aN){T("player:label:speed:"+a.strFullCheck(a6,"default"))}};this.setupInfoText=function(a6){if(aN){T("player:info:text:"+a.strFullCheck(a6,"default"))}};this.setupInfoImage=function(a6){if(aN){T("player:info:image:"+a.strFullCheck(a6,"default"))}};this.setupButton=function(a6,a7){if(aN&&a.isId(a6)){T("player:button:"+a6+":setup",a7)}};this.enableButton=function(a6){if(aN&&a.isId(a6)){T("player:button:"+a6+":enable")}};this.disableButton=function(a6){if(aN&&a.isId(a6)){T("player:button:"+a6+":disable")}};this.focusButton=function(a6){if(aN&&a.isId(a6)){T("player:button:"+a6+":focus")}};this.setupProgressColor=function(a6){if(aN){T("player:progress:color:"+a.strFullCheck(a6,"default"))}};this.setupProgressType=function(a6){if(aN){T("player:progress:type:"+a.strFullCheck(a6,"default"))
